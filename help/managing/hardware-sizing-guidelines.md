...
* 在可擴充性方面，寫操作的數量基本上是最重要的因素；請參閱[作者平行工作](/help/managing/hardware-sizing-guidelines.md#authors-working-in-parallel)以了解作者環境，以及[社交協作](/help/managing/hardware-sizing-guidelines.md#aem-communities-sizing-considerations)了解發佈環境。 可以為僅僅為了處理讀取操作而訪問系統的操作建立負載平衡；如需詳細資訊，請參閱[Dispatcher](https://helpx.adobe.com/experience-manager/dispatcher/user-guide.html) 。
...
* **基準測試1**
   ...
   計算載入設定檔的最大吞吐量，其中使用者在300個現有頁面的基本載入上，執行簡單的建立頁面練習，而所有的現有頁面都具有類似的性質。 相關步驟包括登入網站、使用SWF和影像/文字建立頁面、新增標籤雲，然後啟用頁面。
...
>[!NOTE]
>
>另請參閱[資產效能指南](https://experienceleague.adobe.com/docs/experience-manager-64/deploying/configuring/assets-performance-sizing.html)。
