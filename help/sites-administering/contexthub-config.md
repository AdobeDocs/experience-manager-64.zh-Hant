...
要保存jsontest.com站點的MD5服務中的資料，請使用[使用以下屬性建立ContextHub儲存](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store)中的過程：
...
使用[添加UI模組](/help/sites-administering/contexthub-config.md#adding-a-ui-module)中的過程將UI模組添加到現有UI模式，如示例Perona UI模式。 對於UI模組，請使用下列屬性值：
