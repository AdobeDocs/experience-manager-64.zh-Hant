...
>[!NOTE]
>
>升級至6.4後，建議將檔案從/etc移動。 如需詳細資訊，請參閱AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules)中的[通用資料庫重組。
...
在編輯器中，可以在&#x200B;**過濾器**&#x200B;頁籤中選中／取消選中&#x200B;**I`s Deep`**。
