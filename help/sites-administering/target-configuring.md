...
若要找到雲端設定和架構，請導覽至 **Cloud Services** ( **透過工具** > **部署** > **** Cloud)。 ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
在Adobe Target下方，按一下或點選「顯 **示設定」**。
...
1. 按一 **下「連線至Target** 」以初始化與Target的連線。 如果連接成功，則顯示消息**連接成功**。 按一 **下訊息上** 「確定」，然後 **在對話方塊上** 按「確定」。
