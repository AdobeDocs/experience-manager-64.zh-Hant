...
為持續改善AEM的安全性，Adobe已推出SSL By Default（預設）功能。 其目的是鼓勵使用HTTPS來連線至AEM例項。
...
已為此功能 **建立了名為** ssl-service的服務用戶。 開啟警報後，將引導您完成以下配置嚮導：

1. 首先，設定「商店認證」。 這些是 **ssl-service系統用戶密鑰儲存的憑據** ，將包含HTTPS偵聽器的專用密鑰和信任儲存。

   ![chlimage_1-342](assets/chlimage_1-342.png)

1. 輸入認證後，請按一 **下頁** 右上角的「下一步」。 然後，上傳SSL連線的相關私密金鑰和憑證。
