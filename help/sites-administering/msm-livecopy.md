...
seo-title: 建立和同步Live Copy
description: 了解如何建立和同步Live Copy。
seo-description: 了解如何建立和同步Live Copy。
...
1. 在&#x200B;**Sites**&#x200B;控制台中，選取Blueprint中的頁面，並開啟&#x200B;**[References](/help/sites-authoring/basic-handling.md#references)**&#x200B;面板（從工具列）。
...
1. 從工具欄中選擇&#x200B;**Resume**。
1. 指出您是否要在還原繼承後同步頁面，然後在**繼續即時副本對話方塊中確認&#x200B;**繼續**&#x200B;動**。
