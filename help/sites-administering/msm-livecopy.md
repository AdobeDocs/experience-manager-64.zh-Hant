...
1. 在 **網站** 主控台，在blueprint中選取頁面並開啟 **[參考](/help/sites-authoring/basic-handling.md#references)** 面板（從工具列）。
...
1. 選擇 **繼續** 的上界。
1. 指出您是否要在還原繼承後同步頁面，然後確認 **繼續** 動作(在**繼續即時副本**對話方塊中)。
