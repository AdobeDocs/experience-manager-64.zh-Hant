...
1. 若要將CQ變數對應至Adobe Analytics屬性，請從元件上CQ變數旁的ContentFinder拖曳Adobe Analytics屬性。
   ...
   如需有關最佳化對應的資訊，請參閱[在Adobe Analytics中測量視訊](https://docs.adobe.com/content/help/en/media-analytics/using/sdk-implement/setup/setup-overview.html)指南。
...
* 為與Adobe Analytics屬性對應而定義的CQ變數](#milestones)靜態集。[
