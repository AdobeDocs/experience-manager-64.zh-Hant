...
>
>若要閱讀使用Apache DS配置Experience Manager的範例，請參閱[設定Adobe Experience Manager 6.4以使用Apache Directory Service。](https://helpx.adobe.com/experience-manager/using/configuring-aem64-apache-directory-service.html)
