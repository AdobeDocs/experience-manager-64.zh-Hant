...
>
>要閱讀使用Apache DS配置Experience Manager的示例，請參閱[配置Adobe Experience Manager 6.4以使用Apache目錄服務。](https://helpx.adobe.com/experience-manager/using/configuring-aem64-apache-directory-service.html)
