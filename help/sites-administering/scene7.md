...
1. 導覽回AEM歡迎頁面，然後點選「**[!UICONTROL 工作流程]**」。 連按兩下&#x200B;**DAM更新資產**&#x200B;工作流程以開啟它。
1. 在sidekick中，導覽至&#x200B;**[!UICONTROL Workflow]**&#x200B;元件，並選取&#x200B;**[!UICONTROL Dynamic Media Classic]**。 將&#x200B;**[!UICONTROL Dynamic Media Classic]**&#x200B;拖曳至工作流程，然後點選&#x200B;**[!UICONTROL Save]**。 新增至目標資料夾中AEM Assets的資產會自動上傳至Dynamic Media Classic。
...
您可以導覽至AEM頁面上的Dynamic Media Classic元件，然後點選&#x200B;**[!UICONTROL Edit]**&#x200B;來檢查此項。 資產的URL中會列出安全預覽伺服器。 在AEM中發佈後，檔案參考中的伺服器網域會從預覽URL更新至生產URL。
...
1. 點選「**[!UICONTROL 雲端服務]**」並點選「新增設定&#x200B;]**」，然後選取「**[!UICONTROL &#x200B;動態媒體經典&#x200B;]**」。**[!UICONTROL 
1. 在&#x200B;**[!UICONTROL Adobe Dynamic Media Classic]**&#x200B;下拉式清單中，選取所需的組態，然後點選&#x200B;**[!UICONTROL 確定]**。
...
1. 在「Adobe Experience Manager Web Console設定」面板的&#x200B;**[!UICONTROL OSGi]**&#x200B;功能表上，點選「Configuration」（設定）]**。**[!UICONTROL 
