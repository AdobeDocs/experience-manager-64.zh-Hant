...
執行下列程式，探索Adobe Analytics整合的連結追蹤行為。 程式會顯示 [Adobe Experience Cloud Debugger](https://experienceleague.adobe.com/docs/debugger/using/experience-cloud-debugger.html).
