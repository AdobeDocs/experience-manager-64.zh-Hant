...
請執行下列程式，以探索Adobe Analytics整合的連結追蹤行為。 程式顯示[Adobe Experience Cloud除錯程式](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html)的結果。
