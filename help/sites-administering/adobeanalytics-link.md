...
請執行下列程式，以探索Adobe Analytics整合的連結追蹤行為。 這些程式會顯示 [Adobe Experience Cloud除錯程式的結果](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html)。
