...
>[!NOTE]
>
>設定檔中指定的資訊也可用來透過區段和促銷活動提供使用者 [定](/help/sites-administering/campaign-segmentation.md) 位 [內容](/help/sites-authoring/personalization.md)。

## 註冊表單 {#registration-forms}

表單可用來收集註冊資訊，然後產生新帳戶和描述檔。
