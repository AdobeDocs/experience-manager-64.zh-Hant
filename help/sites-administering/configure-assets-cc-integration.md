...
>[!NOTE]
>
>AEM到Adobe Creative Cloud資料夾共用功能已過時。 進一步瞭解並尋找 [AEM和Creative Cloud整合最佳實務的更佳方法](../assets/aem-cc-integration-best-practices.md)。 AEM至Marketing Cloud的複製設定，以及AEM Assets和Marketing Cloud之間交換資產的設定不會過時。
...
1. 從滑軌移至**[!UICONTROL Administration]**，然後按一下／點選 **[!UICONTROL Launch Enterprise Dashboard]**。
