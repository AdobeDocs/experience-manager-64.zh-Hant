...
1. 根據需要修改和移動形狀。
1. 按一下形狀。
1. 按一下瀏覽圖示可開啟「資 [產」選擇器](/help/assets/asset-selector.md#using-the-asset-selector)。
...
>[!NOTE]
>
>目錄將參考您的產 [品資料](#editing-product-information)。
...
>[!NOTE]
>
>下列範例處理促銷活動中直接持 [有的促](/help/sites-authoring/personalization.md)銷活動，此為憑證。
>
>促銷活動也可以是促銷活 [動中](/help/sites-authoring/personalization.md) 的體驗。
>
>如需詳細資訊，請參 [閱促銷和憑單](#promotions)。
