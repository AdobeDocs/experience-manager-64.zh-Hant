...
1. **Revision Clean Up **任務位於 **每日維護窗口** 功能表。

1. 位於** **每日維護窗口** 功能表。

1. **工作流清除**任務位於 **每週維護窗口** 功能表。
...
有關執行AEM 6.4修訂清除的詳細資訊， [請參閱這篇專屬文章](/help/sites-deploying/revision-cleanup.md).
...
>[!NOTE]
>
>如需有關工作流程維護的詳細資訊，請參閱 [本頁](workflows-administering.md#regular-purging-of-workflow-instances).
