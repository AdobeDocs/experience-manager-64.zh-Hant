...
* **編輯**：新頁面將會開啟，供您 [編輯、新增或移除描述檔屬性](#editing-property-details)。
...
編輯用戶端內容可用來設定（或重設）特定屬性的值。 這可讓您測試特定藍本(對區段和促銷活動 [特別](/help/sites-administering/campaign-segmentation.md)[有用](/help/sites-authoring/personalization.md))。
