---
title: 電子郵件範本最佳作法
description: 尋找有關電子郵件設計的最佳實務，以在Adobe Experience Manager中建立完善的電子郵件行銷活動範本。
contentOwner: User
...
>[!NOTE]
>
>所有促銷活動內容都應在`cq/personalization/components/ambitpage`類型的`master`頁面下建立。 例如，如果您正在規劃促銷活動結構，則會類似：
>
