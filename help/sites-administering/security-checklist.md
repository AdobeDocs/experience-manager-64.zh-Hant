...
1. 導覽至** Apache Felix OSGi Management Console**，並變更使 **用者名** 稱 **和密碼**。
...
>[!NOTE]
>
>如果此實例在「生產就緒模式」下運行，則We.Retail應用 [程式示例將刪除](/help/sites-administering/production-ready.md)。 如果由於任何原因，您可以轉到Package Manager ，然後搜索並卸載所有We.Retail包來卸載示例內容。 如需詳細資訊，請參 [閱如何使用套件](package-manager.md)。
...
1. 前往https://&lt;serveraddress>:4502/crx/de/index.jsp開啟 *CRXDE Lite*
1. 選擇節 `/etc/key` 點。
1. 轉到「復 **制** 」頁籤。
1. 按復 **制** 按鈕。
