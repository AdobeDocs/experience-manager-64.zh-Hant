...
AEM 6.1、6.2SP1、6.3、6.4和6.4 SP1可使用Livefyre Adobe Experience Manager套件。 不支援AEM 5.x和6.0。 如需詳細指示，請參閱 [與Livefyre整合](/help/sites-administering/livefyre.md).

若要查看哪些Livefyre應用程式受支援，請參閱 [Livefyre應用程式的AEM支援對照表](/help/sites-administering/livefyre.md#aem-support-matrix-for-livefyre-apps).
...
1. [快速入門](/help/sites-administering/livefyre.md#getting-started)
1. [設定AEM以使用Livefyre](/help/sites-administering/livefyre.md#configure-aem-to-use-livefyre-create-a-configuration-folder)
1. [將Livefyre策劃的UGC匯入AEM Assets](/help/sites-administering/livefyre.md#use-livefyre-with-aem-assets)
