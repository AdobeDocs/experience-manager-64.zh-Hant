...
2. 捲動至&#x200B;**Adobe Analytics**，然後按一下&#x200B;**可用組態**&#x200B;旁的&#x200B;**[+]**。
...
5. 在側面pod的&#x200B;**報表套裝**&#x200B;區段（主面板右側）中，按一下「新增項目」。 ****&#x200B;然後使用下拉式清單來選取框架將與之互動的報表套裝ID（例如`geometrixxauth`）。

   >[!NOTE]
   >
   >當您選取報表套裝ID時，左側的內容搜尋器會填入Adobe Analytics變數（SiteCatalyst變數）。

6. 然後使用&#x200B;**執行模式**&#x200B;下拉式清單（位於報表套裝ID旁）來選取您要傳送資訊至報表套裝的伺服器例項。

   ![aa-framework-01](assets/aa-framework-01.png)

7. 若要讓架構在您網站的發佈例項上可用，請在sidekick的&#x200B;**Page**&#x200B;標籤上，按一下「啟動架構」。****
