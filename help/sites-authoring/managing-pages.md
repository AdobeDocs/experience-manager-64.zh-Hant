...
此結構可從 **Sites** Console檢視，您可 [在其中瀏覽網站頁面](/help/sites-authoring/basic-handling.md#product-navigation) ，並在頁面上執行動作。 您也可以建立新網站和 [新頁面](#creating-a-new-page)。
...
建立並開啟頁面後，您就可以使 [用元件瀏覽器提供的元件](/help/sites-authoring/editing-content.md#inserting-a-component)，來新增 [內容](/help/sites-authoring/author-environment-tools.md#components-browser)。
...
1. 頁面將會開啟，您可 [以視需要編輯](/help/sites-authoring/editing-content.md) 。
...
1. 如果頁面已連結或參考，則這些參考會列在「調整／重新發 **布」步驟中** 。 您可以指出哪些應視需要調整並重新發佈。
