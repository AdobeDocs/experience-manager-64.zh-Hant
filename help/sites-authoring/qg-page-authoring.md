...
在提供詳細資訊的概述之前，請謹記以下一小組常見提示和提示，尤其是如果您習慣使用[傳統UI製作環境](/help/sites-classic-ui-authoring/classicui.md)。
...
* 不再從頁面編輯器啟動/建立工作流程和版本；現在可從[時間軸](/help/sites-authoring/basic-handling.md#timeline)（可從主控台存取）完成此作業。
...
1. 使用標題](/help/sites-authoring/basic-handling.md#the-header)中的[階層連結向上導覽樹狀結構，讓您返回至選取的位置：
