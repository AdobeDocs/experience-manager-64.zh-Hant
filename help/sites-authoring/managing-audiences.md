...
1. 在「對象」控制台中，點選或按一 **下「建立** 」，然 **後再建立Target對象**。
...
| **瀏覽器** | 您可以定位使用特定瀏覽器或特定瀏覽器選項的使用者瀏覽您的頁面。 | 請參 [閱Adobe Target的](https://docs.adobe.com/content/help/en/target/using/audiences/create-audiences/categories-audiences/browser.html)瀏覽器選項檔案。 |
