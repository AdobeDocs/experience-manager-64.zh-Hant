...
>* 此 [工作流程可能已自訂](/help/sites-developing/workflows-models.md) 由您的開發團隊負責。
...
1. 如果發佈的頁面與工作流程相關聯，最後可能會顯示 **工作流程** 發佈精靈的步驟。
   ...
   >[!NOTE]
   >
   >此 **工作流程** 步驟將根據您的使用者可能擁有或可能沒有的權限顯示。 請參閱 [本頁上的前幾個備注](/help/sites-authoring/publishing-pages.md) 關於發佈權限， [管理工作流程存取權](/help/sites-administering/workflows-managing.md) 和 [將工作流程套用至頁面](/help/sites-authoring/workflows-applying.md) 以取得詳細資訊。
