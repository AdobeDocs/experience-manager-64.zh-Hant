...
1. 如果發佈頁面與工作流程相關聯，則它們可能顯示在發佈精靈的最終&#x200B;**Workflows**&#x200B;步驟中。
   ...
   >[!NOTE]
   >
   >**Workflows**&#x200B;步驟將根據您的用戶可能擁有或可能沒有的權限顯示。 如需詳細資訊，請參閱本頁[上一份有關發佈權限的附註](/help/sites-authoring/publishing-pages.md)，以及[管理工作流程存取權](/help/sites-administering/workflows-managing.md)和[將工作流程套用至頁面](/help/sites-authoring/workflows-applying.md)。
