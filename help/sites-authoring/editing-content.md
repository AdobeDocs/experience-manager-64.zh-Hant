...
1. [編輯](#edit-configure-copy-cut-delete-paste) 元件。
...
如果瀏覽資產時發現您需要快速變更資產，可以啟動 [資產編輯器](/help/assets/managing-assets-touch-ui.md) 按一下資產名稱旁的編輯圖示，即可直接從瀏覽器存取。
...
* [拖放資產](#inserting-a-component-using-the-assets-browser) 從「資產」瀏覽器直接新增內容。
