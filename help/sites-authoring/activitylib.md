...
>
>請參閱 [與Adobe Target整合的先決條件](/help/sites-administering/target-requirements.md) 的上界。
...
1. 按一下或點擊要查看其活動的品牌。
1. 選擇活動，然後按一下或點擊**查看屬性**，然後按一下 **報告** 頁籤，然後選擇要查看/轉換獲勝體驗的效能的活動。 將顯示效能資料。

   ![chlimage_1-239](assets/chlimage_1-239.png)

1. 按一下或點擊 **推送優勝者連結** 將這種體驗作為預設體驗。
