...
1. 按一下或點選您要查看其活動的品牌。
1. Select the activity and click or tap **View Properties **and click the **Reports** tab and select the activity that you want to view performance for/convert winning experiences for. 將顯示效能資料。
...
為避免同步化問題，請務必為活動使用唯一名稱。 如果活動無法同步，您可以刪除Adobe Target中未使用相同名稱的促銷活動。
