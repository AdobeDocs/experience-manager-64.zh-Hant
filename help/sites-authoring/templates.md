...
>[!NOTE]
>
>AEM 6.4.5.0或更新版本必須與[SPA Editor](/help/sites-developing/spa-overview.md)搭配使用可編輯的範本。
...
* 可編輯的範本
   ...
   * 範本作者可使用&#x200B;**Template**&#x200B;主控台和編輯器，建立[](#creating-a-new-template-template-author)和[edited](#editing-templates-template-authors)。 可在&#x200B;**工具**&#x200B;控制台的&#x200B;**一般**&#x200B;部分訪問&#x200B;**模板**&#x200B;控制台。
...
1. 選擇 **建立**。將顯示確認資訊，選擇&#x200B;**Open**&#x200B;開始[編輯模板](#editing-templates-template-authors)或&#x200B;**Done**&#x200B;以返回模板控制台。
...
1. 現在，當[建立新頁面](/help/sites-authoring/managing-pages.md#creating-a-new-page)時，您可以使用範本，不過您可能會想要根據您的需求編輯範本](#editing-templates-template-authors)。[
...
* **原則與屬性（一般）**
   ...
   **選擇策略**&#x200B;下拉清單中選定的現有策略可以使用下拉清單旁的複製按鈕作為新策略進行複製。 然後，應在&#x200B;**Policy Title**&#x200B;欄位中指定新標題。 預設情況下，複製的策略的標題為&#x200B;**Copy of X** ，其中X是複製策略的標題。
   ...
   >[!NOTE]
   >
   >如果將相同類型的多個元件新增為初始內容，則相同的原則會套用至所有元件。 這反映了靜態模板的&#x200B;**[設計模式](/help/sites-authoring/default-components-designmode.md)**&#x200B;中的相同限制。
   ...
   **功能**&#x200B;標籤可讓您啟用或停用元件的其他功能。
   ...
   >[!NOTE]
   >
   >[實施富格文本編輯器的組](/help/sites-administering/rich-text-editor.md) 件的內容策略只能針對RTE通過其UI設定提供的選項進行定義。
...
>[!NOTE]
>
>**使用** 該範本建立的頁面，可考慮編輯初始Contentmode。因此，策略不是在&#x200B;**初始內容**&#x200B;模式中定義，而是在&#x200B;**[結構](/help/sites-authoring/templates.md#editing-a-template-structure-template-author)**&#x200B;模式中定義。
