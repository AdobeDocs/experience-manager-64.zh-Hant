...
如果您需要快速變更資產，可以按一下資產名稱旁顯示的編輯圖示，直接從資產瀏覽器啟動[資產編輯器](/help/assets/managing-assets-touch-ui.md)。
...
* [產品頁面的參考](/help/sites-administering/generic.md#showing-product-references) （可從商務 — 產品主控台取得）
...
* [如果](/help/sites-authoring/templates.md) 頁面是根據可編輯的範本，則 [編輯範本](/help/sites-authoring/templates.md#editable-and-static-templates)
