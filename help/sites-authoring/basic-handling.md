...
登入後，您會立即進入[導覽面板](/help/sites-authoring/basic-handling.md#global-navigation)。 以下章節將更詳細討論此問題。

![screen_shot_2018-03-23at102603](assets/screen_shot_2018-03-23at102603.png)

按一下其中一個選項會開啟個別主控台。 為了充分了解AEM的基本使用，本檔案以&#x200B;**Sites**&#x200B;主控台為基礎。
...
按一下或點選「**Got it！」** 前往概觀的下一頁。按一下或點選「**關閉**」，或按一下或點選「概觀」對話方塊外部以關閉。

除非您勾選「**永不再顯示**」選項，否則概覽將在您下次存取主控台時重新啟動。
...
<table> 
 <tbody>
  ...
  <tr>
   <td>資產<br /> </td> 
   <td>這些主控台可讓您匯入和<a href="/help/assets/assets.md">管理數位資產</a>，例如影像、視訊、檔案和音訊檔案。 然後，在相同AEM例項上執行的任何網站都可以使用這些資產。 </td> 
  </tr>
  <tr>
   <td>社群</td> 
  ...
  <tr>
   <td>商務</td> 
   <td>這可讓您管理與<a href="/help/sites-administering/ecommerce.md">Commerce</a>網站相關的產品、產品目錄和訂單。</td> 
  </tr>
  <tr>
   <td>體驗片段</td> 
  ...
  <tr>
   <td>表單</td> 
   <td>此控制台允許您建立、管理和處理<a href="/help/forms/using/introduction-aem-forms.md">表單和文檔</a>。</td> 
  </tr>
  <tr>
   <td>個性化</td> 
  ...
  <tr>
   <td>網站</td> 
   <td>「網站」主控台可讓您<a href="/help/sites-authoring/author-environment-tools.md">建立、檢視及管理AEM執行個體上執行的網站</a>。 通過這些控制台，您可以建立、編輯、複製、移動和刪除網站頁面、啟動工作流程和發佈頁面。<br /> </td> 
  </tr>
 </tbody>
</table>

1. 在「工具」面板中，側面板中的每個選項都包含一系列子菜單。 此處提供的[工具控制台](/help/sites-administering/tools-consoles.md)可讓您存取許多專門的工具和控制台，以協助您管理網站、數位資產和內容存放庫的其他方面。
...
* 當前控制台。
* 目前的內容。
* 無論您處於[選擇模式](#viewing-and-selecting-resources)。
...
在[卡片檢視](#quick-actions)中，某些動作既可作為快速動作圖示，也可作為工具列使用。 一次只有一個項目可使用快速操作表徵圖，無需預選。
...
**** 參考會顯示與所選資源的任何連線。例如，在&#x200B;**Sites**&#x200B;控制台[參考](/help/sites-authoring/author-environment-tools.md#references)的頁面中，會顯示：
