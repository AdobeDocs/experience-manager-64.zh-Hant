...
>[!CAUTION]
>
>本頁面在介紹基本術語和概念以及建立和管理片段時，必須與[使用內容片段](/help/assets/content-fragments.md)（及相關頁面）一起閱讀。
...
1. 新增&#x200B;**[!UICONTROL 內容片段]**&#x200B;元件；從&#x200B;**[!UICONTROL 元件]**&#x200B;瀏覽器或&#x200B;**[!UICONTROL 插入新元件]**。

1. 您可以:

   * 開啟&#x200B;**[!UICONTROL Assets]**&#x200B;瀏覽器，並篩選&#x200B;**[!UICONTROL 內容片段]**（預設為影像）。 然後將所需片段拖曳至元件例項。
   * 選取內容片段元件，然後從工具列選取&#x200B;**[!UICONTROL 設定]**。 在對話方塊中，您可以開啟選擇對話框以瀏覽並選擇所需的&#x200B;**[!UICONTROL 內容片段]**。

   >[!NOTE]
   >
   >另一種方法是直接將特定內容片段拖曳至頁面。 這會自動建立相關的元件（內容片段）。

1. 最初將顯示&#x200B;**[!UICONTROL Main]**&#x200B;元素和&#x200B;**[!UICONTROL Master]**（變化）中的內容。 您可以視需要選取其他元素和/或變異](#selecting-the-element-or-variation)。[
...
開啟片段的&#x200B;**[!UICONTROL Configuration]**&#x200B;對話方塊，以設定片段以用於目前頁面。 對話方塊取決於使用的元件。
...
您可以使用元件工具列上的&#x200B;**[!UICONTROL Edit]**&#x200B;圖示，開啟片段來源以進行編輯（資產）。 這可讓您[編輯及管理內容片段](/help/assets/content-fragments.md)。
...
將特定內容片段新增至頁面時，片段的每個HTML段落（以及上/下）之間會有&#x200B;**[!UICONTROL 拖曳元件至此處]**&#x200B;預留位置。

這可讓您在中間（即內容之間）](/help/assets/content-fragments.md#in-between-content-when-page-authoring-with-content-fragments)新增額外內容[，而無須變更根片段。
...
>[!NOTE]
>
>有各種方法可將[視覺資產（例如影像）](/help/assets/content-fragments.md#fragments-with-visual-assets)新增至片段和/或頁面。

>[!NOTE]
>
>如果一個頁面上有多個內容片段，**[!UICONTROL 關聯內容]**&#x200B;標籤將顯示適合所有片段的資產。

將具有關聯內容的片段新增至頁面後，會在側面板中開啟新索引標籤（**[!UICONTROL 關聯內容]**）。
...
如果[資產（例如影像）已插入片段本身](/help/assets/content-fragments-variations.md#inserting-assets-into-your-fragment)，則頁面編輯器中用於編輯這些資產的選項有限。
...
* 片段可在[在Assets控制台](/help/assets/content-fragments-managing.md#publishing-and-referencing-a-fragment)中建立片段後發佈。
