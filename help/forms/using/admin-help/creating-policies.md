...
使用Acrobat，您可以在Microsoft outlook中將原則套用至以電子郵件附件形式傳送的檔案。 在Outlook中，您可以使用現有的原則，或使用Acrobat以預設機密設定產生並套用至電子郵件訊息所附檔案的自動產生原則，來保護檔案。 (請參閱* [Acrobat說明](https://help.adobe.com/en_US/acrobat/pro/using/index.html)*)。
