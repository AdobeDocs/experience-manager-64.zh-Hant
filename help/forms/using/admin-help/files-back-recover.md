...
「內容儲存根」目錄的預設位置為&#x200B;*[aem-forms根]*/lccs_data。
...
內容儲存根目錄的預設位置為&#x200B;*[GDS root]*/lccs_data，其中&#x200B;*[GDS root]*&#x200B;是[GDS location](files-back-recover.md#gds-location)中描述的位置。 備份位於「內容儲存根目錄」中的以下目錄：
...
>[!NOTE]
>
>依預設，隨AEM Forms安裝的Adobe字型位於[aem-forms根]/fonts目錄。
