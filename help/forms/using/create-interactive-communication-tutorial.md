...
**網路模板：** [Create_First_IC_Web_Template](/help/forms/using/create-templates-print-web.md)
...
1. 點選 **編輯** 以開啟右窗格中的「互動式通訊」。
1. 執行步驟6 - 15，共 [建立打印通道的互動式通信](#create-interactive-communication-for-print-channel) 區段。
...
1. 重複步驟13 - 18 [為Web通道建立互動式通信](#create-interactive-communication-for-web-channel) 插入 **立即支付** 和 **訂閱** 互動式通訊的Web通道中的超連結。
