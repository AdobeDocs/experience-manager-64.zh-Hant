...
* 可編輯的最適化表單範本
* Acrobat Sign、Typekit、reCAPTCHA和表單資料模型的Cloud Service設定
...
1. 「發佈」程式開始時，會出現確認對話方塊，列出所有相關資產和資源。 在包含相關資產的對話方塊中，點選 **[!UICONTROL 發佈]**. 資產隨即發佈，並出現「發佈資產成功」對話方塊。
   ...
   發佈資產後，您可以使用Forms Portal來顯示網頁上的所有資產。 如需詳細資訊，請參閱 [在入口網站發佈表單簡介](/help/forms/using/introduction-publishing-forms.md).
...
AEM Forms可讓您排程Forms與檔案的資產發佈和取消發佈。 您可以在中繼資料編輯器中指定排程。 如需管理表單中繼資料的詳細資訊，請參閱 [管理表單中繼資料。](/help/forms/using/manage-form-metadata.md)
