...
1. 按一下右鍵/etc/clientlibs子資料夾，然後按一下&#x200B;**[!UICONTROL 建立>建立節點]**。 輸入名稱（此處為afTestRegistration），將節點類型指定為cq:ClientLibraryFolder，然後按一下「確定」。****
...
1. 按一下右鍵測試節點（此處&#x200B;**afTestRegistration）**，然後按一下&#x200B;**[!UICONTROL 建立>建立檔案]**。 命名檔案js.txt，然後按一下「確定」。****
1. 在js.txt檔案中，新增下列文字：
...
1. 按一下&#x200B;**[!UICONTROL 建立]** > **建立節點**&#x200B;以在要測試的每個表單的clientlib資料夾下建立一個節點。 此示例使用名為&#x200B;**testForm**&#x200B;的節點來測試名為&#x200B;**testForm** `.`的自適應表單，然後指定以下屬性並按一下&#x200B;**[!UICONTROL OK]**:
...
1. 按一下右鍵為測試表單建立的資料夾（此處為testForm），然後選擇&#x200B;**[!UICONTROL 建立>建立檔案]**。 將檔案命名為scriptingTest.js，並將下列程式碼新增至檔案，然後按一下「全部儲存」。]****[!UICONTROL 
...
測試AEM最適化表單的步驟與測試AEM UI的步驟類似。 如需測試最適化表單的詳細資訊，請參閱[測試您的UI](https://helpx.adobe.com//experience-manager/6-3/sites-developing/hobbes.html)中的下列主題：
