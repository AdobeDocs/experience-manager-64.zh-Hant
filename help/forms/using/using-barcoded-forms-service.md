...
* **[decode](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/com/adobe/fd/bcf/api/BarcodedFormsService.html#decode)**:對輸入PDF文檔或Tiff影像中可用的所有條形碼進行解碼。它返回另一個XML文檔，該文檔包含從輸入文檔或影像中可用的所有條形碼中檢索到的資料。
