...
* [帳單摘要](/help/forms/using/create-document-fragments.md#step-create-bill-summary-text-document-fragment)
...
使用&#x200B;**FDM_Create_First_IC**（如[建立表單資料模型](create-form-data-model-tutorial.md)部分所述）作為表單資料模型，以在本教程中建立文檔片段。
...
1. 將游標置於&#x200B;**備用聯繫人號碼**&#x200B;欄位旁，按兩下&#x200B;**customer** > **備用行動電話號碼**&#x200B;屬性。
