...
提供的資訊基於以下假設：任何閱讀本文檔的人都熟悉Microsoft® Windows®作業系統。
...
* 下載並安裝與Workbench整合之社群說明用戶端所需的最新版Adobe AIR(位於<a href="http://www.adobe.com/">www.adobe.com</a>)。
* Java™ Runtime Environment(JRE)6.0將22或更新版本更新為6.0 *10*&#x200B;的新版本。
...
1. 前往&#x200B;**控制面板>程式>程式和功能**
1. 在「當前安裝的程式」清單中，選擇&#x200B;**Adobe Acrobat Pro**&#x200B;或&#x200B;**Adobe Acrobat Pro Extended**。
1. 按一下「**Change**」，然後按一下「**Next**」。
1. 選擇&#x200B;**Modify**，然後按一下&#x200B;**Next**。
1. 選擇&#x200B;**Adobe設計器**，選擇&#x200B;**此功能將不可用**，然後按一下&#x200B;**下一步**
1. 按一下&#x200B;**更新**，然後按一下&#x200B;**完成**

### 在Windows 10 {#uninstall-designer-included-with-acrobatpro-or-acrobatextended-windows10}上卸載Acrobat Pro或Acrobat Pro Extended隨附的Designer
...
1. 檢閱發行說明，然後按一下完成。
1. 您的電腦現在安裝了下列項目：
   * **Workbench**:若要從「開始」功能表執行Workbench，請選取「所有程式> AEM Forms > Workbench」（如果您選擇將快捷方式資料夾儲存在此處）。如需資訊，   請參閱使用Workbench檔案。
   * **設計工具**:您可以從Workbench記憶體取「設計工具」。如需詳細資訊，請參閱設計工具說明中的快速入門主題。
   * **Workbench外掛程式**:請依照第6頁「3.3安裝Workbench Eclipse功能」中的指示操作。
   * **AEM Forms SDK**:如需使用SDK的詳細資訊，請參閱使 <a href="http://www.adobe.com/go/learn_lc_programming_10">用AEM Forms程式設計</a>。
...
### 為Workbench {#configuring-eclipse-update-feature-for-workbench}設定Eclipse更新功能
...
* 圖形編輯框架GEF [org.eclipse.gef.feature.group]:這包含在「圖形模型架構SDK」 [org.eclipse.gmf.sdk.feature.group]中

* WST XML核心[org.eclipse.wst.xml_core.feature.group]:這包含在「Eclipse XML編輯器和工具」[org.eclipse.wst.xml_ui.feature.group]中

* 外掛程式&#39;org.apache.commons.lang_2.3.0&#39; [n/a]:這包含在「Mylyn Task List(Required)」[org.eclipse.mylyn_feature.group]中
...
1. 請依照後續畫面上的指示，將Workbench功能部署至Eclipse。
   ...
   >[!NOTE]
   >
   >適用於Flash Builder的AdobeAEM Forms Discovery外掛程式可讓您快速建立AdobeFlex和AIR應用程式，這些應用程式會透過其遠端端點來叫用屬於AEM Forms的服務。 有關如何安裝和更新插件的資訊，可在Adobe網站&#x200B;**Link Required**&#x200B;上找到。
