...
* Workbench_DVD/additional/eclipse從www.eclipse.org/downloads下載及安裝Eclipse 3.6 <a href="https://www.eclipse.org/downloads/">版</a>。

### 設定Workbench的Eclipse更新功能 {#configuring-eclipse-update-feature-for-workbench}
...
1. 請依照後續畫面的指示，將Workbench功能部署至Eclipse。
   ...
   >[!NOTE]
   >
   >Flash Builder專用的Adobe AEM Forms Discovery外掛程式可讓您快速建立Adobe Flex和AIR應用程式，透過遠端端點叫用屬於AEM Forms一部分的服務。 如需如何安裝和更新外掛程式的詳細資訊，請造訪Adobe網站，網址為 **Link Required**。

### 配置和登錄到伺服器 {#configuring-and-logging-server}
