...
如需表單資料整合和表單資料模型的詳細資訊，請參 [閱AEM Forms Data Integration](/help/forms/using/data-integration.md)。
...
* MySQL資料庫，其示例資料如建立第一個自適應表單的「先決條件」 [部分中所述](/help/forms/using/create-your-first-adaptive-form.md)
...
1. 在AEM作者例項上，導覽至「表 **單>資料整合」**。 預設URL為 [http://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm](http://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm)。
