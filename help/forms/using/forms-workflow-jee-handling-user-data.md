...
1. 建立公用例項 `ProcessManager` 客戶端( `com.adobe.idp.workflow.client.ProcessManager`)使用 `ServiceClientFactory` 執行個體，且連線設定正確。
   ...
   如需詳細資訊，請參閱的Java API參考 [類ProcessManager](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/com/adobe/idp/workflow/client/ProcessManager.html).
