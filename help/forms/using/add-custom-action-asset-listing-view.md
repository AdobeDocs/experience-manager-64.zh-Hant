...
1. 在應用程式檔案夾中，使用下列步驟建立名為項目的檔案夾，其路徑／結構類似於位於選擇檔案夾中的項目檔案夾：
   ...
   1. 在以下路徑中按一下右鍵&#x200B;**[!UICONTROL items]**&#x200B;資料夾，然後選擇&#x200B;**[!UICONTROL 覆蓋節點]**:
...
1. 在新建立的項目資料夾下，為特定資產中的自訂按鈕／動作新增節點(範例：downloadFlatPDF)，使用下列步驟：
   ...
   1. 按一下右鍵&#x200B;**[!UICONTROL items]**&#x200B;資料夾，然後選擇&#x200B;**[!UICONTROL 建立]** > **[!UICONTROL 建立節點]**。
...
1. 在應用程式檔案夾中，使用下列步驟建立名為js的檔案夾，其路徑／結構類似於管理資料夾中的items檔案夾：
   ...
   1. 按一下&#x200B;**[!UICONTROL 「確定」]**。資料夾結構會建立在應用程式資料夾中。 按一下&#x200B;**[!UICONTROL 保存全部]**。
...
1. 在新建立的項目節點下，為特定資產中的自訂按鈕／操作添加節點(示例：letterpdfdownloader)，使用下列步驟：
   ...
   1. 確保「建立節點」對話框具有以下值，然後按一下&#x200B;**[!UICONTROL 確定]**:
      ...
      **[!UICONTROL 名稱：]** letterpdfdownloader(或您要提供給此屬性的名稱——必須是唯一的。如果您在此處使用不同的名稱，也請在formaction.js檔案的ACTION_URL變數中指定相同的名稱。)
...
1. 在以下位置使用用於命令操作處理的代碼建立名為POST.jsp的檔案：
   ...
   1. 按一下右鍵以下路徑上的&#x200B;**[!UICONTROL admin]**&#x200B;資料夾，然後選擇&#x200B;**[!UICONTROL 建立>建立檔案]**:

      /apps/fd/cm/ma/gui/components/admin/clientlibs/admin

      將檔案命名為POST.jsp。 (檔案名稱僅需要為POST.jsp。)

   1. 連按兩下&#x200B;**[!UICONTROL POST.jsp]**&#x200B;檔案，以在CRX中開啟它。
   1. 將以下代碼添加到POST.jsp檔案中，然後按一下&#x200B;**[!UICONTROL 全部保存]** :
...
1. 選擇&#x200B;**[!UICONTROL Forms>字母]**。 Commense Management會列出系統中可用的信件。
1. 按一下&#x200B;**[!UICONTROL 選擇]** ，然後按一下字母選擇它。
1. 選擇「**[!UICONTROL 更多]** > &lt;下載平面PDF>」（使用本文說明建立的自訂功能）。 將顯示「以PDF格式下載信函」對話框。
...
1. 在「以PDF格式下載信函」對話方塊中，選取您要在PDF中填入資料的相關XML。
   ...
   >[!NOTE]
   >
   >在將信函下載為平面PDF之前，您可以使用&#x200B;**[!UICONTROL 建立報表]**&#x200B;選項，建立包含信函中資料的XML檔案。
