...
您可以使用「指派任務」步驟來建立任務並指派給使用者或群組。 將任務指派給用戶或組時，會向已定義用戶或已定義組的每個成員發送電子郵件通知。 典型的[電子郵件通知](/help/forms/using/use-custom-email-template-assign-task-step.md)包含指派任務的連結和與任務相關的資訊。
