  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li><strong></strong> 採用Sun SPARC的環境：UltraSPARC v或更高版本</li> 
     <li><strong></strong> 採用IBM AIX的環境：Power6或更新版本<br /> </li> 
...
* 安裝的磁碟空間：僅適用於Workbench 1.7 GB，在單一磁碟機上2.7 GB，可完整安裝Workbench、Designer和樣本元件400 MB（適用於臨時安裝目錄）- 200 MB（適用於用戶臨時目錄）和200 MB（適用於Windows臨時目錄）
