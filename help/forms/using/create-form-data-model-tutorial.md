...
如需表單資料整合與表單資料模型的詳細資訊，請參閱[AEM Forms Data Integration](data-integration.md)。
...
您可以設定不同類型的資料來源以建立表單資料模型。 在本教程中，您將配置已配置並填入示例資料的MySQL資料庫。 如需其他支援資料來源的詳細資訊以及如何設定這些資料來源，請參閱[AEM Forms Data Integration](data-integration.md)。
...
AEM Forms提供直覺式使用者介面，讓您從設定的資料來源建立表單資料模式[l。 ](data-integration.md)您可以在表單資料模型中使用多個資料來源。 在本教程中，您將使用MySQL作為資料源。
...
1. 在AEM作者例項上，導覽至&#x200B;**Forms** > **Data Integrations**。 預設URL為[http://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm](http://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm)。
