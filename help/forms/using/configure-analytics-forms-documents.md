...
1. 以管理員身分登入您的AEM製作例項。
1. 在左上角，按一下 **Adobe Experience Manager** > **工具** ![工具](assets/tools.png)> **Cloud Services** > **舊版Cloud Services**.
...
1. 在製作執行個體上，開啟AEM Web Console Configuration manager(網址為https://&lt;)*伺服器*>:&lt;*埠*>/system/console/configMgr。
