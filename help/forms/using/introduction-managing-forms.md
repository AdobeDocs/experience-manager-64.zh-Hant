...
AEM工具面板包含各種元件的工具。 若要導覽至AEM Forms特定工具，請按一下 **Experience Manager logo** ![adobeexperiencemanager](assets/adobeexperiencemanager.png) > **** Hammer Tools ![](assets/hammer.png)****> FormsCropts。 將顯示用於執行下列功能的工具：
