...
1. 從資料面板，將資料字典元素和預留位置元素拖放至文字。
   ...
   **圖：** *CCR視圖中的佔位符元素值從資料字典變數中填充，如示例資料檔案中所指定*
...
1. 點選「 **表格** 」索引標籤並指定版面的下列資訊：
   ...
   * **寬度比：** 表格欄寬比。
   ...
   如需在版面片段中使用靜態和動態表格的詳細範例，請參 [閱範例檔案： 在字母中使用靜態和動態表](create-letter.md#insert-data-modules-and-layout-fragments-in-a-letter-and-configure-them)。
