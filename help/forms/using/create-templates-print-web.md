...
1. 選擇 **檔案** > **另存新檔** 要在本地檔案系統上保存檔案，請執行以下操作：
   ...
   使用Forms設計工具建立版面片段的XDP範本後，您必須 [上傳](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server) 傳送至AEM Forms伺服器，讓範本可在建立版面片段時使用。
