...
1. 選擇「**檔案** > **另存為**」以在本地檔案系統中保存檔案：
   ...
   使用Forms Designer為版面片段建立XDP範本後，您必須[upload](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server)將它上傳至AEM Forms伺服器，以便在建立版面片段時使用範本。
