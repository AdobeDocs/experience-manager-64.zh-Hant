...
[AEM Forms工作區自訂的一般步驟](/help/forms/using/generic-steps-html-workspace-customization.md)中涵蓋最常用的步驟。 如需此類自訂的特定範例，包括詳細步驟，請參閱本文結尾的相關文章。
...
您可以自訂AEM Forms工作區，以新增使用者的變數，或新增組織的標誌。 對於這些定制，請使用[Ship Package](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)。
...
若要開始自訂AEM Forms工作區中的影像，請依照[AEM Forms工作區自訂的一般步驟](/help/forms/using/generic-steps-html-workspace-customization.md)進行。 如需影像相關自訂的特定範例，請參閱本文結尾的相關說明主題。
...
如需此類自訂的特定範例，請參閱本文結尾提供的「說明」主題。 選擇[Ship Package](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)或[Dev Package](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)，視要自訂的範本而定。
...
* CRX套件，適用於出貨、除錯和開發描述檔（[CRX套件](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)中提及）。
* 自訂程式碼的精簡版（用於語義變更）。
