...
目前不提供從LiveCycle ES2、LiveCycle ES3、AEM 6.0 Forms、AEM 6.1 Forms直接升級至AEM 6.4 Forms的功能。 您可以執行一或多個LiveCycle或AEM Forms版本的中階升級，然後從AEM 6.4 Forms升級。 有關中間版本和相應升級說明的清單，請參 [閱選擇升級路徑](upgrade.md)。
