...
使用AEM檔案服務建立Maven專案所需的用戶端類別，可在[AEM Forms用戶端SDK](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) jar中取得。 如需Maven專案的相關資訊，請參閱[如何使用Maven](/help/sites-developing/ht-projects-maven.md)建立AEM專案。
