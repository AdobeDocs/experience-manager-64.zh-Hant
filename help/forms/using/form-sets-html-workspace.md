...
表單集是HTML5表單的集合，分組後以單一表單集的形式呈現給使用者。 當使用者開始填寫表格集時，可順暢地從一個表格轉換到另一個表格。 然後，只要按一下，就可提交表格集。 如需表單集的詳細資訊以及如何設定，請參閱「AEM Forms[中的表單集」。](/help/forms/using/formset-in-aem-forms.md)
