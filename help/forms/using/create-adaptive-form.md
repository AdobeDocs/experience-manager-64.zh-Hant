...
1. 將&#x200B;**提交按鈕**&#x200B;元件拖曳至最適化表單。 將其置於頁尾元件之前。 開啟元件的屬性，將「元素名稱」變更為&#x200B;**address_addition_update_submit**，點選![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)。 表單的版面已完成，表單看起來如下所示：
