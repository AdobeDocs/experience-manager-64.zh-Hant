...
+ 快速入門 {#getting-started}
   ...
   + 教學課程：建立第一個最適化表單{#create-first-adaptive-form}
      ...
      + [教學課程：設定您自訂表單的樣式](using/style-your-adaptive-form.md)
...
+ 安裝並配置AEM Forms{#install-aem-forms}
   ...
   + 在OSGi {#osgi-installation}上安裝AEM Forms
      + [OSGi上支AEM援的表格平台](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + 在JEE上安裝AEM Forms{#jee-installation}
      ...
      + [在JEE上使用JBoss Tunkly安裝和部署AEM Forms](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      ...
      + [在JBoss的JEE上安裝和部署Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [在WebLogic的JEE上安裝和部署AEM Forms](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      ...
      + [在JBoss群集上配置JEE上的Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [在WebLogic群集上配置JEE上的Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [在WebSphere群集上配置JEE上的Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ 升級AEM Forms{#upgrade-aem-forms}
   ...
   + 升級OSGi上的AEM Forms{#aem-forms-osgi-upgrade}
      + [升級至AEMOSGi上的6.4表格](using/upgrade-forms-osgi.md)
   ...
   + 升級JEE上的AEM Forms{#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager FormsJEE升級清單與規劃](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [升級至AEMJEE上的6.4表格](using/upgrade-forms-jee.md)
      + [升級至Adobe Experience Manager FormsJBoss的JEE](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [從LiveCycleES4 SP1升級到JBoss的JEE上的Adobe Experience Manager Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [升級至AEM FormsJEE for JBoss Tunky](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [從LiveCycleES4 SP1升級到JEE上的JBoss Tunky](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [在WebLogic的JEE上升級至Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [從LiveCycleES4 SP1升級至Adobe Experience Manager Forms的WebLogic JEE](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [升級至Adobe Experience Manager Forms的WebSphere JEE](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [從LiveCycleES4 SP1升級至Adobe Experience Manager Forms的WebSphere JEE](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
...
+ 最適化Forms-進階編寫{#adaptive-forms-advanced-authoring}
   ...
   + [最適化表單的標準驗證錯誤訊息](using/standard-validation-error-messages-adaptive-forms.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [設計人員快速入門Tutorials](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
...
+ 開發人員參考{#developer-reference}
   + [開發人員基本資訊](https://docs.adobe.com/content/help/en/experience-manager-64/developing/home.html)
   ...
   + [適用於AdaptiveForms的JavaScript程式庫API參考](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
