...
description: '使用權限管理服務Java API建立策略、修改策略、刪除策略、將策略應用於PDF文檔、從PDF文檔中刪除策略、撤消文檔、恢復對已撤消文檔的訪問、檢查受策略保護的PDF文檔、建立水印、修改水印、搜索事件以及從Word文檔中刪除策略。 '
seo-description: 使用權限管理服務Java API建立策略、修改策略、刪除策略、將策略應用於PDF文檔、從PDF文檔中刪除策略、撤消文檔、恢復對已撤消文檔的訪問、檢查受策略保護的PDF文檔、建立水印、修改水印、搜索事件以及從Word文檔中刪除策略。
