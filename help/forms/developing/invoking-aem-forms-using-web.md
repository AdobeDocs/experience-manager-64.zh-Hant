...
1. 將下列Axis JAR檔案新增至Java專案的類別路徑：
   ...
   * xercesImpl.jar
   ...
   這些JAR檔案位於&#x200B;*[install目錄]*/Adobe/Adobe Experience Manager Forms/sdk/lib/協力廠商目錄中。
...
此程式不以現有的AEM Forms程式為基礎。 要遵循程式碼範例，請使用Workbench建立名為`MyApplication/EncryptDocument`**的程式。 （請參閱[使用Workbench](https://www.adobe.com/go/learn_aemforms_workbench_63)。）
