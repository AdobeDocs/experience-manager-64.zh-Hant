...
description: 使用加密服務Java API來加密PDF文檔、刪除基於密碼的加密、使用證書加密PDF文檔、刪除基於證書的加密、解鎖加密的PDF文檔以及確定加密類型。
...
以下Java代碼示例將加密名為 *Loan.pdf* 具有 *Encryption.cer*. 加密的PDF文檔將保存為PDF檔案，該檔案名為 *EncryptLoanCert.pdf*. (請參閱 [使用憑證加密PDF檔案](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-certificates).)
