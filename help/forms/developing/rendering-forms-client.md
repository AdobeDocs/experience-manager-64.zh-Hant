...
description: 使用Acrobat或Adobe Reader的用戶端轉譯功能，以最佳化PDF內容的傳送，並改善Forms服務處理網路負載的能力。
seo-description: 使用Acrobat或Adobe Reader的用戶端轉譯功能，以最佳化PDF內容的傳送，並改善Forms服務處理網路負載的能力。
