...
以下代碼示例使用Forms服務Java API在客戶端轉換名為*Loan.xdp *的表單。 請注意，表單設計是應用程式的一部分，使用內容根URI值`repository:///`來參考。 (請參閱[在客戶端上呈現Forms。)](/help/forms/developing/rendering-forms.md#rendering-forms-at-the-client)
