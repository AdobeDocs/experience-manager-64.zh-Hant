...
[UGC公共儲存](working-with-srp.md)由多種儲存資源提供器(SRP)之一提供，每個儲存資源提供器可能具有不同的本地查詢語言。 因此，無論選擇何種SRP，自訂代碼都應使用[UGC API套件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/ugc/api/package-summary.html)(*com.adobe.cq.social.ugc.api*)中的方法，這些方法將調用適合於所選SRP的查詢語言。
...
若要修改現有索引或建立自訂索引，請參閱[Oak Queries and Indexing](../../help/sites-deploying/queries-and-indexing.md)。
...
若要檢視[CRXDE Lite](../../help/sites-developing/developing-with-crxde-lite.md)中現有的Oak索引，其位置為：
...
新增自訂屬性時，為了讓這些屬性對使用[UGC搜尋API](#ugc-search-api)建立的排序和搜尋可見，必須使用*required *才能在屬性名稱中新增字尾。
