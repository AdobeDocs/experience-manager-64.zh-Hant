...
若要解決錯誤，請依照[安裝標準MLS](solr.md#installing-standard-mls)的指示，請確定
...
1. 從[https://search.maven.org/#artifactdetails%7Corg.mongodb%7Cmongo-java-driver%7C2.13.2%7Cjar](https://search.maven.org/#artifactdetails%7Corg.mongodb%7Cmongo-java-driver%7C2.13.2%7Cjar)下載驅動程式(2.13.2版或更高版本)
