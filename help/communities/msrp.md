...
>[!NOTE]
>
>預設為名稱`communities`的mongoDB資料庫不應設定為用於[節點儲存或資料（二進位）儲存](../../help/sites-deploying/data-store-config.md)的資料庫的名稱。 另請參見6](../../help/sites-deploying/storage-elements-in-aem-6.md)中的AEM[儲存元素。
