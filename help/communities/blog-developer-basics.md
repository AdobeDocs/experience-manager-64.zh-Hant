...
如需詳細資訊，請參閱[主要發行者](deploy-communities.md#primary-publisher)。
...
透過選取`Embed Media from External Sites`圖示，將豐富型媒體內嵌在部落格文章中： ![chlimage_1-471](assets/chlimage_1-471.png)
