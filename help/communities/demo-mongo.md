...
1. 安裝[standard](msrp.md#installingstandardmls)或[advanced](msrp.md#installingadvancedmls)多語言搜索(MLS)
...
1. 在mongodb **[!UICONTROL Communities >集合>內容]**&#x200B;中檢視UGC
...
1. 確認MSRP已設為預設提供者：
   ...
   * 在所有製作和發佈AEM例項上，重新造訪[儲存設定主控台](srp-config.md)
