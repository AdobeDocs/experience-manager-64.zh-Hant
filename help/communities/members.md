...
* **[!UICONTROL ID]**
(
*必要*)可授權的ID是成員的登入ID。依預設，ID會設為所需電子郵件地址的值。
   *建立後，ID就無法修改。*

* **[!UICONTROL 電子郵件地址]**
(
*必要*)會員的電子郵件地址。成員在更新其個人檔案時可能會變更其電子郵件地址。I
...
* **[!UICONTROL 貢獻]**
限制如果勾選，會員張貼內容的能力會受到限制。預設值取決於貢獻限制的設定。
請參閱[成員貢獻限制](limits.md)。

* **[!UICONTROL 更改]**
修改現有成員時存在的PasswordA連結。提供社區管理員重設成員密碼的能力。
