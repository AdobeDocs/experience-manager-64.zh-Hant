---
title: AEM 6.4 Communities 使用指南
seo-title: AEM 6.4 Communities User Guide
description: 本指南涵蓋AEM Communities的所有任務，如建立論壇、用戶組、學習資源和其他社交功能等線上體驗。
...
# AEM 6.4 Communities 使用指南

本指南涵蓋AEM Communities的所有任務，如建立論壇、用戶組、學習資源和其他社交功能等線上體驗。
