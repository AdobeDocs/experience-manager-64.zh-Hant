...
已更新電子商務整合架構的Hybris擴充功能，以支援Hybris 5（預設為），同時維持與的向後相容性 [Hybris 4](/help/sites-developing/sap-commerce-cloud.md#developing-for-hybris).
...
>[!NOTE]
>
>適用於開發人員 [API檔案](/help/sites-developing/ecommerce.md#api-documentation) 也可供下載。
...
1. 從側欄導覽， **系統** 和 **工具**. 然後選取 **匯入** 開啟 **嚮導：CSV匯入** 窗口。
