...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>用法：jvisualvm或visualvm<br /> </p> <p>請參 <a href="https://java.sun.com/javase/6/docs/technotes/tools/share/jvisualvm.html">閱使用(J)VisualVM</a>、 <a href="https://visualvm.github.io/releases.html">visualvm</a><a href="#monitoring-performance-using-j-visualvm">和監控效能</a>。</p> <p><strong></strong> 注意：使用JDK 1.6,VisualVM可以通過插件進行擴展。</p> </td> 
  </tr> 
  <tr> 
   <td>桁架／網架，lsof</td> 
