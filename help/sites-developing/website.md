...
>[!NOTE]
>
>使用預設埠在本機安裝的AEM製作執行個體CRXDE Lite的URL為 [http://localhost:4502/crx/de/](http://localhost:4502/crx/de/).

## 在CRXDE Lite中設定專案結構 {#setting-up-the-project-structure-in-crxde-lite}

使用CRXDE Lite在儲存庫中建立mywebsite應用程式結構：

1. 在CRXDE Lite左側的樹中，按一下右鍵 **`/apps`** 資料夾，按一下 **[!UICONTROL 建立>建立資料夾]**. 在 **建立資料夾** 對話框，類型 `mywebsite` 作為資料夾名稱，然後按一下 **確定**.
1. 以滑鼠右鍵按一下 `/apps/mywebsite` 資料夾，按一下 **[!UICONTROL 建立>建立資料夾]**. 在 **[!UICONTROL 建立資料夾]** 對話框，類型 `components` 作為資料夾名稱，然後按一下 **[!UICONTROL 確定]**.
1. 以滑鼠右鍵按一下 `/apps/mywebsite` 資料夾，按一下 **[!UICONTROL 建立>建立資料夾]**. 在 **[!UICONTROL 建立資料夾]** 對話框，類型 `templates` 作為資料夾名稱，然後按一下 **[!UICONTROL 確定]**.
...
>[!NOTE]
>
>按一下以下連結即可下載 ``mywebsite.zip``. 封存包含您設計的static.css和影像檔案。
...
1. 在資料夾樹中，選取 **[!UICONTROL 設計]** ，然後按一下 **[!UICONTROL 新增>新頁面]**. 類型 `mywebsite` 作為標題，然後按一下 **[!UICONTROL 建立]**.

1. 如果表中未顯示mywebsite項，請刷新樹或表。

1. [使用WebDAV](/help/sites-administering/webdav-access.md) http://localhost:4502上存取URL，請複製範例 `static.css` 檔案和 `images` 資料夾（從下載的mywebsite.zip檔案）放入 `/etc/designs/mywebsite` 檔案夾。
...
1. 在CRXDE Lite的資料夾樹中，按一下右鍵 `/apps/mywebsite/templates` 按一下 **[!UICONTROL 建立>建立範本]**.
...
1. 若要指定可使用此範本的頁面路徑，請按一下加號按鈕並輸入 `/content(/.*)?` 框中。 然後，按一下 **[!UICONTROL 下一個]**.

   ![chlimage_1-105](assets/chlimage_1-105.png)

   允許的路徑屬性的值為 *規則運算式。* 路徑符合運算式的頁面可使用範本。 在此情況下，規則運算式會比對 `/content` 資料夾和所有子頁面。

   作者在下方建立頁面時 `/content`, **[!UICONTROL contentpage]** 範本會顯示在要使用的可用範本清單中。

1. 按一下 **[!UICONTROL 下一個]** 在 **[!UICONTROL 允許的父項]** 和 **[!UICONTROL 允許的子項]** 面板，按一下 **[!UICONTROL 確定]**. 在CRXDE Lite中，按一下 **[!UICONTROL 全部儲存]**.
...
1. 在CRXDE Lite中，按一下右鍵 `/apps/mywebsite/components` 按一下 **[!UICONTROL 建立>元件]**.
1. 在 **[!UICONTROL 建立元件]** 對話框，鍵入以下屬性值：
...
1. 按一下 **[!UICONTROL 下一個]** 直到 **[!UICONTROL 允許的子項]** 對話框的面板，然後按一下 **[!UICONTROL 確定]**. 在CRXDE Lite中，按一下 **[!UICONTROL 全部儲存]**.
...
1. 按一下 **[!UICONTROL 全部儲存]** 來儲存變更。

### 建立您的網站頁面和內容頁面 {#creating-your-website-page-and-content-pages}

在本節中，您將建立以下所有頁面均使用內容頁面範本：我的網站，英文、產品、服務和客戶。

1. 在AEM歡迎頁面([http://localhost:4502/libs/cq/core/content/welcome.html](http://localhost:4502/libs/cq/core/content/welcome.html))，按一下「網站」。

   ![chlimage_1-109](assets/chlimage_1-109.png)

1. 在資料夾樹中，選取 **[!UICONTROL 網站]** ，然後按一下 **[!UICONTROL 新增>新頁面]**.
1. 在 **[!UICONTROL 建立頁面]** ，請輸入以下內容：

   * **[!UICONTROL 標題]**: `My Website`
   * **[!UICONTROL 名稱]**: `mywebsite`
   * 選取 **[!UICONTROL 我的網站內容頁面範本]**

   ![chlimage_1-110](assets/chlimage_1-110.png)

1. 按一下&#x200B;**[!UICONTROL 建立]**。在資料夾樹中，選取 `/Websites/My Website` 頁面，按一下 **[!UICONTROL 新增>新頁面]**.
1. 在 **[!UICONTROL 建立頁面]** 對話框，輸入以下屬性值，然後按一下「建立」：

   * **[!UICONTROL 標題]**:英文
   * **[!UICONTROL 名稱]**:en
   * 選取 **[!UICONTROL 我的網站內容頁面範本]**

1. 在資料夾樹中，選取 `/Websites/My Website/English` 頁面，按一下 **[!UICONTROL 新增>新頁面]**.
1. 在 **[!UICONTROL 建立頁面]** 對話框，輸入以下屬性值，然後按一下 **[!UICONTROL 建立]**:
...
1. 若要將您的頁面連結至我的網站設計，請在CRXDE Lite中選取 `/content/mywebsite/en/jcr:content` 節點。 在 **[!UICONTROL 屬性]** 頁簽，鍵入新屬性的以下值，然後按一下添加：
...
1. 在新的Web瀏覽器頁簽或窗口中，開啟 [http://localhost:4502/content/mywebsite/en/products.html](http://localhost:4502/content/mywebsite/en/products.html) 若要查看產品頁面：
...
1. 在CRXDE Lite中，建立檔案 `left.jsp` 在 `/apps/mywebsite/components/contentpage`:
   ...
   1. 以滑鼠右鍵按一下節點 `/apps/mywebsite/components/contentpage`，然後選取 **[!UICONTROL 建立]** then **[!UICONTROL 建立檔案]**.
   1. 在視窗中，輸入 `left.jsp` 作為**名稱**，然後按一下 **[!UICONTROL 確定]**.
...
1. 在CRXDE Lite中，建立檔案 `center.jsp` 在 `/apps/mywebsite/components/contentpage`:
   ...
   1. 以滑鼠右鍵按一下節點 `/apps/mywebsite/components/contentpage`，選取 **[!UICONTROL 建立]**，然後 **[!UICONTROL 建立檔案]**.
   1. 在對話方塊中，輸入 `center.jsp` as **[!UICONTROL 名稱]** 按一下 **[!UICONTROL 確定]**.
...
1. 在CRXDE Lite中，建立檔案 `right.jsp` 在 `/apps/mywebsite/components/contentpage`:
   ...
   1. 以滑鼠右鍵按一下節點 `/apps/mywebsite/components/contentpage`，選取 **[!UICONTROL 建立]**，然後 **[!UICONTROL 建立檔案]**.
   1. 在對話方塊中，輸入 `right.jsp` as **[!UICONTROL 名稱]** 按一下 **[!UICONTROL 確定]**.
...
1. 在CRXDE Lite中，按一下右鍵 `/apps/mywebsite/components`，選取 **[!UICONTROL 建立]**，然後 **[!UICONTROL 建立元件]**.
1. 在 **[!UICONTROL 建立元件]** ，請輸入以下內容：

   * **[!UICONTROL 標籤]**: `topnav`
   * **[!UICONTROL 標題]**: `My Top Navigation Component`
   * **[!UICONTROL 說明]**: `This is My Top Navigation Component`

1. 按一下 **[!UICONTROL 下一個]** 直到您進入您按一下 **[!UICONTROL 確定]**. 儲存您的變更。
...
此 **[!UICONTROL 頁面]** 元件定義屬性，讓您為頁面提供字幕。 新增提供頁面內容相關資訊的字幕。

1. 在瀏覽器中，開啟 **[!UICONTROL 產品]** 頁面。
1. 在Sidekick **[!UICONTROL 頁面]** 按一下 **[!UICONTROL 頁面屬性]**.
1. 在 **[!UICONTROL 基本]** 頁簽，展開 **[!UICONTROL 更多標題和說明]** 和 **[!UICONTROL 副標題]** 屬性，類型 `what we do`. 按一下&#x200B;**[!UICONTROL 「確定」]**。
1. 重複前述步驟以添加字幕 **關於我們的服務** 到 **[!UICONTROL 服務]** 頁面。
1. 重複前述步驟以添加字幕 **我們贏得的信任** 到 **[!UICONTROL 客戶]** 頁面。
...
1. 儲存變更。
1. 以滑鼠右鍵按一下 `/apps/mywebsite/components/contentpage` 節點，按一下 **[!UICONTROL 建立>建立檔案]**.
1. 在 **[!UICONTROL 建立檔案]** 窗口，作為 **[!UICONTROL 名稱]**，類型 `navimage.png.java`.
...
1. 將下列程式碼複製至 `navimage.png.java.`該代碼擴展了AbstractImageServlet類：
   ...
   * [AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html) 建立ImageContext對象，該對象儲存當前資源的屬性。
   * 資源的上層頁面從ImageContext物件中擷取。 然後獲得頁面標題和字幕。
   * [ImageHelper](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/ImageHelper.html) 用於從站點設計的navimage_bg.jpg檔案、頁面標題和頁面字幕生成影像。
...
建立位於 **[!UICONTROL 產品]** 頁面。 請針對說明兩個特定產品的每個頁面，設定標題、說明和日期。

1. 在 **[!UICONTROL 網站]** 頁面，選擇 **[!UICONTROL 網站/我的網站/英文/產品]** 項目，按一下 **[!UICONTROL 新增>新頁面]**.
1. 在對話方塊中輸入下列屬性值，然後按一下 **[!UICONTROL 建立]**:
...
1. 在CRXDE Lite中，設定產品2頁面的說明和日期：
   ...
   1. 選取 `/content/mywebsite/en/products/product2/jcr:content` 節點。
   1. 在 **[!UICONTROL 屬性]** 標籤中輸入以下值：
...
1. 在CRXDE Lite中，按一下右鍵 `/apps/mywebsite/components`，選取 **[!UICONTROL 建立]**，然後 **[!UICONTROL 建立元件]**.
1. 在對話方塊中輸入下列屬性值，然後按一下 **[!UICONTROL 下一個]**:

   * **[!UICONTROL 標籤]**:列出孩子。
   * **[!UICONTROL 標題]**:我的清單子項元件。
   * **[!UICONTROL 說明]**:這是我的Listchildren元件。

1. 繼續按一下 **[!UICONTROL 下一個]** 直到 **[!UICONTROL 允許的子項]** 面板隨即出現，然後按一下 **[!UICONTROL 確定]**.
...
1. 在listchildren元件下建立對話框節點：
   ...
   1. 在CRXDE Lite中，以滑鼠右鍵按一下 `/apps/mywebsite/components/listchildren`節點，按一下 **[!UICONTROL 建立>建立對話方塊]**.
   1. 在對話方塊中，輸入以下屬性值，然後按一下確定

      * **[!UICONTROL 標籤]**: `dialog`
      * **[!UICONTROL 標題]**: `Edit Component` 按一下 **[!UICONTROL 確定]**.
...
1. 在 **[!UICONTROL 屬性]** ，請變更 **[!UICONTROL 標題]** 屬性 `List Children`

   ![chlimage_1-117](assets/chlimage_1-117.png)

1. 選取 **tab1** 節點，按一下 **[!UICONTROL 建立>建立節點]**，請輸入以下屬性值，然後按一下 **[!UICONTROL 確定]**:
...
1. 新增清單節點的屬性，以將其設定為文字欄位。 下表中的每一列代表一個屬性。 完成後，按一下 **[!UICONTROL 全部儲存]**.
...
1. 作為清單根的路徑，請輸入： `/content/mywebsite/en`. 按一下&#x200B;**[!UICONTROL 「確定」]**。您頁面上的listchildren元件現在如下所示：
...
1. 在「CRXDE Lite」中，按一下右鍵/apps/mywebsite/components，選擇 **[!UICONTROL 建立]**，然後 **[!UICONTROL 建立元件]**.
...
1. 按「下一步」，直到到達對話方塊的最終面板，然後按一下 **[!UICONTROL 確定]**.
...
1. 在徽標元件下建立對話框節點：
   ...
   1. 以滑鼠右鍵按一下 `/apps/mywebsite/components/logo` 節點，按一下 **[!UICONTROL 建立>建立對話方塊]**.
   1. 輸入下列屬性值，然後按一下 **[!UICONTROL 確定]**:

      * **[!UICONTROL 標籤]** `design_dialog`
      * **[!UICONTROL 標題]** `Logo (Design)`

1. 按一下右鍵design_dialog分支中的tab1節點，然後按一下「刪除」。 按一下 **[!UICONTROL 全部儲存]**.
1. 在 `design_dialog/items/items`節點，建立名為 `img` 類型 `cq:Widget`. 新增下列屬性，然後按一下 **[!UICONTROL 全部儲存]**:
...
1. 以滑鼠右鍵按一下標誌元件節點，然後按一下 **[!UICONTROL 建立>建立檔案]** 建立名為img.GET.java的指令碼檔案。
1. 開啟檔案，將下列程式碼複製到檔案中，然後按一下 **[!UICONTROL 全部儲存]**:
...
1. 使用 **[!UICONTROL 產品]** 頁面在瀏覽器中開啟，按一下 **[!UICONTROL 設計]** 按鈕進入 **[!UICONTROL 設計]** 模式。

   ![](do-not-localize/chlimage_1-10.png)

1. 在徽標欄的設計中，按一下 **[!UICONTROL 編輯]** 使用對話框編輯徽標元件的設定。
1. 在對話方塊中，按一下 **[!UICONTROL 影像]** 頁簽，瀏覽 `logo.png` 您從 `mywebsite.zip` ，然後按一下 **[!UICONTROL 確定]**.

   ![chlimage_1-124](assets/chlimage_1-124.png)

1. 按一下Sidekick標題列上的三角形以返回 **[!UICONTROL 編輯]** 模式。
...
1. 儲存變更。
1. 在您的瀏覽器中，重新載入 **[!UICONTROL 產品1]** 頁面。 軌跡元件如下所示：
...
1. 以滑鼠右鍵按一下 `/apps/mywebsite/components/logo` 節點，按一下 **[!UICONTROL 複製]**.
1. 以滑鼠右鍵按一下 `/apps/mywebsite/components` 節點，按一下 **[!UICONTROL 貼上]**.
1. 以滑鼠右鍵按一下 `Copy of logo` 節點，按一下 **[!UICONTROL 重新命名]**，刪除現有文字和類型 `image`.
...
1. 在CRXDE Lite中，以滑鼠右鍵按一下檔案 `/libs/foundation/components/image/icon.png` 選取 **[!UICONTROL 複製]**.
1. 以滑鼠右鍵按一下節點 `/apps/mywebsite/components/image` 按一下 **[!UICONTROL 貼上]**，然後按一下 **[!UICONTROL 全部儲存]**.

#### 使用影像元件 {#using-the-image-component}

在本節中，您將檢視 **[!UICONTROL 產品]** 頁面，並將您的影像元件新增至段落系統。

1. 在您的瀏覽器中，重新載入 **[!UICONTROL 產品]** 頁面。
1. 在Sidekick中，按一下 **[!UICONTROL 設計模式]** 表徵圖。
1. 按一下 **[!UICONTROL 編輯]** 按鈕，編輯par的設計對話框。
1. 在對話方塊中， **[!UICONTROL 允許的元件]** 顯示；導覽至 **[!UICONTROL MyWebsite]**，請選取 **[!UICONTROL 我的影像元件]** 按一下 **[!UICONTROL 確定]**.
1. 返回 **[!UICONTROL 編輯模式]**.
1. 連按兩下parsys框架(開啟 **[!UICONTROL 將元件或資產拖曳至此處]**)。 此 **[!UICONTROL 插入新元件]** 和 **[!UICONTROL Sidekick]** 選取器如下所示：
...
1. 在「AEM網站」頁面的資料夾樹中，選取 `Websites/My Website/English`，然後按一下 **[!UICONTROL 新增>新頁面]**. 指定下列屬性值，然後按一下「建立」：

   * **[!UICONTROL 標題]**:工具列
   * 選擇 **[!UICONTROL 我的網站內容頁面範本]**

1. 在頁面清單中，以滑鼠右鍵按一下 **[!UICONTROL 工具列]** 頁面，按一下 **[!UICONTROL 屬性]**. 選擇 **[!UICONTROL 在導覽中隱藏]**，然後按一下 **[!UICONTROL 確定]**.

   此 **[!UICONTROL 在導覽中隱藏]** 選項會防止頁面出現在導覽元件中，例如topnav和listchildren。

1. 在 **[!UICONTROL 工具列]**，建立下列頁面：
...
1. 使用對話方塊來設定元件：
   ...
   1. 按一下 **[!UICONTROL 下一個]**，然後按一下 **[!UICONTROL 下一個]** 。
   1. 在 **[!UICONTROL 允許的父項]** 面板，按一下 **[!UICONTROL +]** 按鈕和類型 `*/parsys`.
   1. 按一下 **[!UICONTROL 下一個]** 然後按一下 **[!UICONTROL 確定]**.
...
1. 在瀏覽器中，開啟 **搜尋** 頁面。
1. 在Sidekick中，按一下 **[!UICONTROL 設計]** 模式表徵圖。
1. 在Design of par block（在Search標題下）中，按一下 **[!UICONTROL 編輯]**.
1. 在對話方塊中，向下捲動至 **[!UICONTROL 我的網站]** 組，選擇 **[!UICONTROL 我的搜尋元件]** 按一下 **[!UICONTROL 確定]**.
1. 在Sidekick上，按一下三角形以返回 **[!UICONTROL 編輯]** 模式。
1. 拖曳 **[!UICONTROL 我的搜尋]** 元件從Sidekick移入parsys框架中。 如下所示：

   ![chlimage_1-133](assets/chlimage_1-133.png)

1. 導覽至 **[!UICONTROL 產品]** 頁面。 在輸入方塊中搜尋客戶，然後按 **[!UICONTROL 輸入]**. 系統會將您重新導向至 **[!UICONTROL 搜尋]** 頁面。 切換至 **[!UICONTROL 預覽]** 模式：輸出的格式與以下類似：
