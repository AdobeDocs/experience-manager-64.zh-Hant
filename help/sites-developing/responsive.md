...
`com.day.cq.wcm.foundation.impl.AdaptiveImageComponentServlet`類擴展了[AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html)類。 AdaptiveImageComponentServlet原始碼位於`/libs/foundation/src/impl/src/com/day/cq/wcm/foundation/impl`資料夾中。
...
`AbstractImageServlet`類提供處理HTTP請求的`doGet`方法。 此方法會判斷與請求相關聯的資源，從儲存庫中擷取資源屬性，並在[ImageContext](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.ImageContext.html)物件中傳回。

>[!NOTE]
>
>[com.day.cq.commons.DownloadResource](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/DownloadResource.html)類提供`getFileReference method`，用於檢索資源`fileReference`屬性的值。
...
info.geometrixx.commons.impl.servlets.ImageReferenceModificationServlet類擴展了[AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html)類。 如果已安裝cq-geometrixx-commons-pkg套件，則ImageReferenceModificationServlet原始碼位於`/apps/geometrixx-commons/src/core/src/main/java/info/geometrixx/commons/impl/servlets`資料夾中。
...
`AbstractImageServlet`類提供處理HTTP請求的`doGet`方法。 此方法會判斷與呼叫相關聯的資源，從存放庫中擷取資源屬性，並將其儲存在[ImageContext](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.ImageContext.html)物件中。

`ImageReferenceModificationServlet`類覆蓋`createLayer`方法並實現確定要呈現的影像資源的邏輯。 方法會擷取頁面`jcr:content`節點（名為`image`）的子節點。 從此`image`節點建立[影像](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/Image.html)對象，而`getFileReference`方法從影像節點的`fileReference`屬性返回影像檔案的路徑。

>[!NOTE]
>
>[com.day.cq.commons.DownloadResource](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/DownloadResource.html)類提供getFileReferencemethod。
