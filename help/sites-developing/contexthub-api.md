...
向ContextHub註冊UI模組轉換器。 註冊轉譯器後，它可用於[建立UI模組](/help/sites-administering/contexthub-config.md#adding-a-ui-module)。 在[擴充ContextHub.UI.BaseModuleRenderer](/help/sites-developing/ch-extend.md#creating-contexthub-ui-module-types)時使用此函式，以建立自訂的UI模組轉譯器。
