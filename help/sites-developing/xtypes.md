...
如需AEM中所有可用介面工具集的完整資訊，請參閱[介面工具集API檔案](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html)。
...
* box
   ...
   任何[元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)的基類，其大小為框，使用寬度和高度。
...
* browsedialog
   ...
   BrowseDialog允許用戶瀏覽儲存庫以選擇路徑。 它通常透過[BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField)使用。
...
* browsefield
   ...
   **已棄用：使 [用CQ.form.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) PathFieldstead**
...
* bulkeditor
   ...
   BulkEditor必須插入HTML表單（匯入功能所需）。 這可搭配[CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)正常運作。
...
* checkboxgroup
   ...
   [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox)控制項的分組容器。
...
* colorfield
   ...
   ColorField可讓使用者直接或使用[CQ.Ext.ColorMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu)輸入色彩十六進位值。
...
* colormenu
   ...
   包含[CQ.Ext.ColorPalette](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette)元件的菜單。
...
* 容器
   ...
   可能包含其他元件的任何[CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent)的基類。 容器處理容納項的基本行為，即添加、插入和刪除項。
...
* contentfinder
   ...
   ContentFinder是一個專用的兩列[Viewport](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport)，左側包含實際的「內容查找器」，右側包含「內容框架」。
...
* contentfindertab
   ...
   ContentFinderTab是專門的面板，提供[CQ.wcm.ContentFinder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)的頁簽面板中使用的功能。 它通常具有搜尋表單（查詢方塊）和顯示搜尋的資料檢視。
...
* cq.workflow.model.combo
   ...
   WorkflowModelCombo是自定義的[CQ.Ext.form.ComboBox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox)，顯示可用的工作流模型清單。
...
* customcontentpanel
   ...
   CustomContentPanel是一種特殊類型的面板，用於[CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog):其內容會從中擷取，並提交至對話方塊中其他欄位以外的不同URL。
...
* datefield
   ...
   提供日期輸入欄位，其中包含[CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker)下拉式清單和自動日期驗證。
...
* datemenu
   ...
   包含[CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker)元件的功能表。
...
* datepicker
   ...
   彈出式日期選擇器。 此類由[DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField)類使用，以允許瀏覽和選擇有效日期。
...
* dialofieldset
   ...
   DialogFieldSet是[FieldSet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FieldSet)，用於[Dialogs](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)。
...
* 編輯欄
   ...
   雖然未在此處列出，但EditBar具有[CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase)的所有成員。
...
* 編輯滾動
   ...
   [CQ.wcm.EditRolver](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditRollover)
...
* 欄位集
   ...
   用於將[form](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel)內的項目分組的標準容器。...
...
* 群組儲存
   ...
   專門的儲存實施，它提供按可用欄位之一對記錄進行分組。 這通常與[CQ.Ext.grid.GroupingView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GroupingView)結合使用，以證明分組的GridPanel的資料模型。
...
* htleditor
   ...
   編輯器的工具欄按鈕在[buttonTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor)屬性中定義了工具提示。
...
* listview
   ...
   CQ.Ext.list.ListView是[Grid](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)贊檢視的快速且輕量實作。
...
* lvcolumn
   ...
   此類封裝要用於初始化[ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView)的列配置資料。
...
* mediabrowsedialog
   ...
   **已棄用：請改 [用「](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder) 內容尋找器」來瀏覽媒體。**
...
* 功能表
   ...
   菜單對象。 這是您可新增功能表項目的容器。 當您想要以其他元件為基礎的專用功能表時（例如[CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu)），功能表也可作為基本類別。

   菜單可以包含[菜單項](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.Item)或常規[元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)s。
...
* 門項
   ...
   需要與菜單相關功能（如子菜單）且不是靜態顯示項的所有菜單項的基類。 Item通過添加特定於菜單的激活和點擊處理擴展了[CQ.Ext.menu.BaseItem](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem)的基本功能。
...
* 面板
   ...
   面板由於其從[CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container)繼承而成。

* 段落參考

   [CQ.form.ParaghReference](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.ParagraphReference)
...
* 密碼
   ...
   密碼類似於[CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField)，但保持其值為私有，允許用戶輸入敏感資料。
...
* pathfield
   ...
   PathField是為具有路徑完成的路徑設計的輸入欄位，以及開啟[CQ.BrowseDialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog)以瀏覽伺服器儲存庫的按鈕。 它也可以瀏覽頁面段落以產生進階連結。
...
* 進度
   ...
   在手動模式中，您負責顯示、更新（透過[updateProgress](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ProgressBar)），並視需要從您自己的程式碼中清除進度列。 如果您想要顯示進度，此方法最合適。
...
* 屬性網格
   ...
   一種專門的網格實現，旨在模擬開發IDE中通常出現的傳統屬性網格。 格線中的每一行代表某些對象的屬性，而資料儲存為[CQ.Ext.grid.PropertyRecord](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)s中的一組名稱/值對。
...
* 快速提示
   ...
   @xtype quicktip（快速提示）工具提示的專用工具提示類，可在標籤中指定，並由全局[CQ.Ext.QuickTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips)實例自動管理。 有關其他使用詳細資訊和示例，請參閱快速提示類標題。
...
* 放射組
   ...
   [CQ.Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio)控制項的分組容器。
...
* 統計計畫
   ...
   RolloutPlan提供對話方塊，可監視頁面轉出進度。 RolloutPlan由[CQ.wcm.msm.RolloutWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard)啟動。
...
* 滾花
   ...
   轉出精靈提供精靈，可轉出頁面。 RolloutWizard會啟動[CQ.wcm.msm.RolloutPlan](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan)。
...
* 幻燈片放映
   ...
   幻燈片放映元件基於[CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage)元件。
...
* 建議欄位
   ...
   [CQ.form.SougkedField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SuggestField)
...
* 表編輯
   ...
   **已棄用：請 [改用CQ.form.TableEdit2](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2) 。**
...
* textbutton
   ...
   TextButton提供具有[CQ.Ext.Button](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button)功能的文本連結。
...
* 觸發
   ...
   為新增可點按觸發按鈕的TextFields提供便利的包裝函式（預設情況下看起來類似組合框）。 觸發器沒有預設動作，因此您必須指派函式以透過覆寫[onTriggerClick](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField)來實作觸發器點按處理常式。 您可以直接建立TriggerField，因為它呈現的完全像一個組合框。
