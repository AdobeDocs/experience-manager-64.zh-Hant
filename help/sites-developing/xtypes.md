...
如需AEM中所有可用Widget的完整資訊，請參閱[Widget API檔案](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html)。
...
* 框
   ...
   任何[元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)的基類（使用寬度和高度，尺寸為方塊）。
...
* 瀏覽對話框
   ...
   BrowseDialog允許用戶瀏覽儲存庫以選擇路徑。 它通常通過[BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField)使用。
...
* 瀏覽器欄位
   ...
   **已過時：使 [用CQ.form.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) PathFieldstead**
...
* bulkeditor
   ...
   BulkEditor必須插入HTML表單（匯入功能所需）。 這與[CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)完美搭配運作。
...
* checkboxgroup
   ...
   [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox)控制項的群組容器。
...
* 容器
   ...
   任何可能包含其他元件的[CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent)的基類。 容器可處理包含項目的基本行為，即添加、插入和移除項目。
...
* contentfinder
   ...
   ContentFinder是專用的兩欄[Viewport](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport)，其中包含左側的實際內容搜尋器和右側的內容影格。
...
* contentfindertab
   ...
   ContentFinderTab是專用面板，提供[CQ.wcm.ContentFinder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)的標籤面板中使用的功能。 通常它包含搜尋表單（查詢方塊）和顯示搜尋的資料檢視。
...
* cq.workflow.model.combo
   ...
   WorkflowModelCombo是自訂的[CQ.Ext.form.ComboBox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox)，顯示可用的工作流程模型清單。
...
* customcontentpanel
   ...
   CustomContentPanel是用於[CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)的特殊面板：其內容會從對話方塊中擷取並送出至與其他欄位不同的URL。
...
* datefield
   ...
   提供包含[CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker)下拉式清單和自動日期驗證的日期輸入欄位。
...
* datemenu
   ...
   包含[CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker)元件的菜單。
...
* 編輯欄
   ...
   EditBar雖然未列在此處，但具有[CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase)的所有成員。
...
* fieldset
   ...
   用於將[表單](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel)內的項目分組的標準容器。...
...
* listview
   ...
   CQ.Ext.list.ListView是[Grid](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)類似檢視的快速輕量實作。
...
* lvcolum
   ...
   此類封裝用於[ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView)初始化的列配置資料。
...
* mediabrowsedialog
   ...
   **已過時：請改 [用「](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder) 內容尋找」來瀏覽媒體。**
...
* 菜單
   ...
   功能表物件。 這是您可新增功能表項目的容器。 當您想要根據其他元件（例如[CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu)）建立專用功能表時，功能表也可當成基本類別。

   菜單可包含[菜單項](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.Item)或常規[元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)。
...
* menuitem
   ...
   需要功能表相關功能（如子功能表）且非靜態顯示項目的所有功能表項目的基本類別。 Item通過添加特定於菜單的激活和按一下處理擴展了[CQ.Ext.menu.BaseItem](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem)的基本功能。
...
* 面板
   ...
   面板通過其對[CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container)的繼承而成。
...
* 密碼
   ...
   密碼類似[CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField)，但保持其值為私密，允許用戶輸入敏感資料。
...
* pathfield
   ...
   PathField是專為路徑完成而設計的輸入欄位，它用於開啟[CQ.BrowseDialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog)以瀏覽伺服器儲存庫的按鈕。 它也可以瀏覽頁面段落，以產生進階連結。
...
* 進度
   ...
   在手動模式下，您負責顯示、更新（透過[updateProgress](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ProgressBar)），並視需要從您自己的代碼中清除進度列。 此方法最適合您要顯示進度時。
...
* 屬性網格
   ...
   專用的格線實作，旨在模仿開發IDE中的常見傳統屬性格線。 網格中的每一行表示某些對象的屬性，並且資料以一組名稱／值對的形式儲存在[CQ.Ext.grid.PropertyRecord](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)s中。
...
* 快速提示
   ...
   @xtype quicktip為工具提示提供的專用工具提示類別，可在標籤中指定，並由全域[CQ.Ext.QuickTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips)例項自動管理。 請參閱QuickTips類別標題，以取得其他使用詳細資訊和範例。
...
* 放射組
   ...
   [CQ.Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio)控制項的群組容器。
...
* 統計計畫
   ...
   RovoltPlan提供對話方塊，可監看頁面的推出進度。 LovoltPlan由[CQ.wcm.msm.LovoltWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard)啟動。

* 滾水板

   [CQ.wcm.msm.LovoltWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard)

   RovoltWizard提供用於展開頁面的精靈。 LovoltWizard會啟動[CQ.wcm.msm.LovoltPlan](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan)。
...
* 投影片
   ...
   投影片元件是以[CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage)元件為基礎。
...
* textbutton
   ...
   TextButton提供具有[CQ.Ext.Button](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button)功能的文字連結。
...
* 觸發器
   ...
   為TextFields提供方便的包裝函式，可新增可點按的觸發按鈕（依預設會顯示為combox）。 觸發器沒有預設操作，因此您必須通過覆蓋[onTriggerClick](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField)來指派函式來實現觸發器按一下處理程式。 您可以直接建立TriggerField，因為它會呈現得完全像一個組合方塊。
