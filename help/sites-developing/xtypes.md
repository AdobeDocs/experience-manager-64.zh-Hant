...
如需AEM中所有可用小工具的完整資訊，請參閱 [介面工具集API檔案](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html).
...
* box
   ...
   任何的基類 [元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) 即使用寬度和高度作為框的大小。
...
* browsedialog
   ...
   BrowseDialog允許用戶瀏覽儲存庫以選擇路徑。 它通常透過 [BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField).
...
* browsefield
   ...
   **已棄用：使用 [CQ.form.PathField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) inde**
...
* bulkeditor
   ...
   BulkEditor必須插入HTML表單（匯入功能所需）。 這和 [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog).
...
* checkboxgroup
   ...
   用於 [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) 控制項。
...
* colorfield
   ...
   ColorField可讓使用者直接或使用 [CQ.Ext.ColorMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu).
...
* colormenu
   ...
   包含 [CQ.Ext.ColorPalette](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) 元件。
...
* 容器
   ...
   任何的基類 [CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent) 可能包含其他元件。 容器處理容納項的基本行為，即添加、插入和刪除項。
...
* contentfinder
   ...
   ContentFinder是專用的兩欄 [檢視區](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) 左側包含實際的「內容尋找器」，右側包含「內容框架」。
...
* contentfindertab
   ...
   ContentFinderTab是專門的面板，提供用於 [CQ.wcm.ContentFinder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder). 它通常具有搜尋表單（查詢方塊）和顯示搜尋的資料檢視。
...
* cq.workflow.model.combo
   ...
   WorkflowModelCombo是自定義的 [CQ.Ext.form.ComboBox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox) 顯示可用工作流模型清單。
...
* datefield
   ...
   提供日期輸入欄位，並搭配 [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 下拉式清單和自動日期驗證。
...
* datemenu
   ...
   包含 [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 元件。
...
* datepicker
   ...
   彈出式日期選擇器。 此類由 [日期欄位](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) 類別，以允許瀏覽並選取有效日期。
...
* dialofieldset
   ...
   DialogFieldSet是 [欄位集](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FieldSet) 用於 [對話方塊](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog).
...
* 編輯欄
   ...
   雖然未在此處列出，但EditBar具有 [CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase).
...
* 欄位集
   ...
   用於對 [表單](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel)....
...
* 群組儲存
   ...
   專門的儲存實施，它提供按可用欄位之一對記錄進行分組。 這通常與 [CQ.Ext.grid.GroupingView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GroupingView) 來證明分組網格面板的資料模型。
...
* htleditor
   ...
   編輯器的工具列按鈕在 [buttonTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor) 屬性。
...
* listview
   ...
   CQ.Ext.list.ListView是快速且輕量的 [格線](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) 如視圖。
...
* lvcolumn
   ...
   此類封裝要用於初始化的列配置資料 [ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView).
...
* mediabrowsedialog
   ...
   **已棄用：使用 [內容尋找器](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder) 來瀏覽媒體。**
...
* 功能表
   ...
   菜單對象。 這是您可新增功能表項目的容器。 當您想要以其他元件為基礎的專用功能表時(例如 [CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu) 例如)。

   功能表可包含 [功能表項目](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.Item)或一般 [元件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)s.
...
* 門項
   ...
   需要與菜單相關功能（如子菜單）且不是靜態顯示項的所有菜單項的基類。 項目擴展了 [CQ.Ext.menu.BaseItem](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem) 新增功能表特定啟動，然後按一下處理。
...
* 面板
   ...
   這些面板，由於它們繼承了 [CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container).
...
* 密碼
   ...
   密碼就像 [CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) 但會將其值保持為私密，讓使用者能夠輸入敏感資料。
...
* pathfield
   ...
   PathField是一個輸入欄位，專為具有路徑完成的路徑設計，還有一個按鈕，用於開啟 [CQ.BrowseDialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog) 瀏覽伺服器儲存庫。 它也可以瀏覽頁面段落以產生進階連結。
...
* 屬性網格
   ...
   一種專門的網格實現，旨在模擬開發IDE中通常出現的傳統屬性網格。 格線中的每一列代表某些物件的屬性，且資料會儲存為中的一組名稱/值組 [CQ.Ext.grid.PropertyRecord](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)s.
...
* 快速提示
   ...
   @xtype快速提示(Quicktip)為工具提示提供專門的工具提示類，可在標籤中指定，並由全局自動管理 [CQ.Ext.QuickTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips) 例項。 有關其他使用詳細資訊和示例，請參閱快速提示類標題。
...
* 放射組
   ...
   用於 [CQ.Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio) 控制項。
...
* 統計計畫
   ...
   RolloutPlan提供對話方塊，可監視頁面轉出進度。 轉出計畫由 [CQ.wcm.msm.RolloutWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard).
...
* 滾花
   ...
   轉出精靈提供精靈，可轉出頁面。 轉出精靈啟動 [CQ.wcm.msm.RolloutPlan](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan).
...
* 幻燈片放映
   ...
   投影片放映元件以 [CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage) 元件。
...
* 表編輯
   ...
   **已棄用：使用 [CQ.form.TableEdit2](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2) 。**
...
* textbutton
   ...
   TextButton提供具有 [CQ.Ext.Button](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button).
...
* 觸發
   ...
   為新增可點按觸發按鈕的TextFields提供便利的包裝函式（預設情況下看起來類似組合框）。 觸發器沒有預設動作，因此您必須指派函式以透過覆寫來實作觸發器點擊處理常式 [onTriggerClick](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField). 您可以直接建立TriggerField，因為它呈現的完全像一個組合框。
