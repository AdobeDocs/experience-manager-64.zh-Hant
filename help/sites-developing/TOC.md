...
+ 延AEM伸{#extending-aem}
   ...
   + [整合服務與JMX主控台](https://experienceleague.adobe.com/docs/experience-manager-64/developing/platform/jmx-integration.html)
...
+ 最佳作法{#bestpractices}
   ...
   + [開AEM發准則和最佳實務](https://experienceleague.adobe.com/docs/experience-manager-64/developing/introduction/dev-guidelines-bestpractices.html)
