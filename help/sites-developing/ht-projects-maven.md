...
* [在GitHub上開啟aem-uberjar-demo專案](https://github.com/justinedelson/aem-uberjar-demo)
* 將專案下載為 [ZIP檔案](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)
...
>[!NOTE]
>
>除非您如上所述匯入產品相依性，否則還需要將它們與符合您AEM設定的版本一起新增至父POM，如上所述。 下面每個條目中的注釋顯示要在「相依性查找器」中搜索的包。
