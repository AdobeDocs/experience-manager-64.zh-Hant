...
* 以[CQ QueryBuilder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/QueryBuilder.html)為基礎。
...
此對話方塊是標準的CQ [dialog](/help/sites-developing/components-basics.md#dialogs)，可依此設定（如需詳細資訊，請參閱[CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)）。
