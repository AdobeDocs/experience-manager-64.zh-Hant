...
seo-title: 將ContextHub新增至頁面及存取商店
description: 將ContextHub新增至您的頁面，以啟用ContextHub功能並連結至ContextHub Javascript程式庫
seo-description: 將ContextHub新增至您的頁面，以啟用ContextHub功能並連結至ContextHub Javascript程式庫
...
* [PeristingStore](/help/sites-developing/contexthub-api.md#contexthub-store-persistedstore)
