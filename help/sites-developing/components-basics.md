...
* **觸控式UI**
   [在5.6.0](/help/sites-developing/touch-ui-concepts.md) 中引進的標準使用者介面AEM是6.x中的預覽與延伸。它以Adobe Marketing Cloud的統一使用者體驗為基礎，採用 [Coral ](/help/sites-developing/touch-ui-concepts.md#coral-ui) UI和 [Granite UI的基礎技術](/help/sites-developing/touch-ui-concepts.md#granite-ui)。
...
在開發您自己的元件時，有關使用[HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html)或JSP(Java Server Pages)的討論應該是直接的，因為HTL現在是建議的指令碼語言AEM。
