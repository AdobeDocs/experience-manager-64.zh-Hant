...
* **[!UICONTROL 逾時]**
   ...
   您可以選擇：立 **[!UICONTROL 即、1]**&#x200B;小時、 **[!UICONTROL 1小時、]** 1小時、 **[!UICONTROL 1小時、]************** 2小時、24小時。
...
此容 **[!UICONTROL 器]]**可讓您重複使用工作流程模型來實施常用的步驟順序。 例如，翻譯工作流程模型可用於多個編輯工作流程。
...
「 **[!UICONTROL OR分割]** 」(OR Split)在工作流中建立分割，之後只有一個分支處於活動狀態。 此步驟可讓您將條件式處理路徑引入工作流程。 您可以視需要將工作流程步驟新增至每個分支。
...
* **[!UICONTROL 對話方塊]**
   ...
   * **[!UICONCONTROL對話框路徑**:您所建立對話框的對話框節 [點的路徑](#dialog-participant-step-creating-a-dialog)。
...
「啟動工作流模型時，日誌會指示啟動工作流的用戶的ID，以及分配了工作項的用戶。 在此示例中，用 `admin` 戶啟動了工作流。
...
* **[!UICONTROL 表單]**
   ...
   * **[!UICONCONTROL表單路徑**:您建立的表 [單路徑](#form-participant-step-creating-the-form)。
