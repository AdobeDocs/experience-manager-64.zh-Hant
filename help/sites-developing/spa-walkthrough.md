...
1. 選取標題元件，並注意工具列會像其他元件一樣顯示。 選擇&#x200B;**[!UICONTROL 編輯]**。
...
1. 在發佈伺服器上或使用頁面編輯器中的「頁面資訊」選單中的「檢視為已發佈」選項&#x200B;**[!UICONTROL ，載入We.Retail Journal應用程式。]******
...
1. 如果尚未載入，請在發佈伺服器上載入We.Retail Journal應用程式，或使用頁面編輯器中的&#x200B;**頁面資訊**&#x200B;菜單中的&#x200B;**[!UICONTROL 查看為發佈]**&#x200B;選項。
...
1. 將`react.model.json`載入新標籤中。
   ...
   AEM SPA編輯器運用[AEM Content Services](/help/assets/content-fragments.md)將頁面的整個內容以JSON模型形式提供。
