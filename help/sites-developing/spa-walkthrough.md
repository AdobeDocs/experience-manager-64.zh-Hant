...
1. 選取標題元件，並注意工具列的顯示方式與任何其他元件相同。 選擇&#x200B;**[!UICONTROL Edit]**。
...
1. 在發佈伺服器上或使用頁面編輯器中&#x200B;**頁面資訊**&#x200B;功能表的&#x200B;**[!UICONTROL 以Published]**&#x200B;檢視來載入We.Retail Journal應用程式。
...
1. 如果尚未載入，請在發佈伺服器上或使用頁面編輯器中&#x200B;**頁面資訊**&#x200B;選單的&#x200B;**[!UICONTROL 以已發佈的形式查看]**&#x200B;來載入We.Retail Journal應用程式。
...
1. 在新索引標籤中載入`react.model.json`。
   ...
   AEM SPA編輯器會運用[AEM內容服務](/help/assets/content-fragments.md)，以JSON模型形式提供頁面的整個內容。
