...
所有這些功能都是透過標準AEM安裝中提供的一連串預設[Form元件](/help/sites-authoring/default-components.md)來實現。
...
1. 在資料夾中建立以下任一項：
   ...
   1. 貼文指令碼。
      ...
      提交表單以處理表單時，會叫用後置指令碼，其中包含處理從`POST`表單到達的資料的代碼。
...
有關編寫指令碼時可使用的API元素的詳細資訊，請參閱[與表單相關的](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/forms/package-summary.html)。
