...
contexthub.browserinfo UI模組顯示有關客戶端Web瀏覽器和作業系統的資訊。 根據contexthub.surferinfo儲存庫候選項，從surferinfo儲存 [中獲取資訊](/help/sites-developing/ch-samplestores.md#contexthub-surferinfo-sample-store-candidate) 。
