...
>* 資訊位置的變更請參閱AEM 6.4](/help/sites-deploying/repository-restructuring.md)中的[存放庫重新調整和[工作流程最佳實務 — 位置](/help/sites-developing/workflows-best-practices.md#locations)。
