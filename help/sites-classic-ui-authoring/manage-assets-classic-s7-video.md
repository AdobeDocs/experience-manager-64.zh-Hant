...
1. 在Dynamic Media Classic中，[設定排程的FTP上傳和編碼至Dynamic Media Classic（系統自動化）](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/uploading-files.html#uploading-your-files)。
...
1. 按一下&#x200B;**[!UICONTROL Upload]**&#x200B;上傳主視訊。 視訊上傳和編碼在[!UICONTROL  DAM更新資產]工作流程完成且&#x200B;**[!UICONTROL 發佈至Dynamic Media Classic]**&#x200B;有核取記號後完成。

   >[!NOTE]
   >
   >可能需要一些時間才能產生視訊縮圖。

   將DAM主視訊拖曳至視訊元件時，可存取&#x200B;*all*&#x200B;的Dynamic Media Classic編碼代理轉譯以進行傳送。

### Foundation視訊元件與Dynamic Media Classic視訊元件{#foundation-video-component-versus-scene-video-component}比較

使用AEM時，您可以同時存取Sites和Dynamic Media Classic(Scene7)視訊元件中的視訊元件。 這些元件不可互換。
...
1. 在AEM中，轉至&#x200B;**[!UICONTROL 工具]**，然後選擇&#x200B;**[!UICONTROL 配置控制台]**。 在Configuration Console中，導覽至導覽樹狀結構中的&#x200B;**[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL Video Profiles]**。
1. 建立新的Dynamic Media Classic影片設定檔。 在&#x200B;**[!UICONTROL 新……]**&#x200B;功能表，選取&#x200B;**[!UICONTROL 建立頁面]**，然後選取Dynamic Media Classic視訊設定檔範本。 為新視訊設定檔頁面命名，然後按一下「**[!UICONTROL 建立]**」。
