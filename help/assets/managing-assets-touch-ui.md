...
對於已指派處理設定檔的檔案夾，描述檔名稱會出現在卡片檢視的縮圖上。 在清單視圖中，配置檔案名稱將顯示在&#x200B;**[!UICONTROL 處理配置檔案]**&#x200B;列中。 請參閱[處理配置式](processing-profiles.md)。
...
1. 若要上傳資產，請執行下列其中一項作業：
   ...
   * 在工具列上，點選&#x200B;**[!UICONTROL Create]**&#x200B;圖示。 然後，在功能表上點選「**[!UICONTROL 檔案]**」。 如有需要，可在顯示的對話框中更名檔案。
   * 在支援HTML5的瀏覽器中，直接將資產拖曳至介面。 不會顯示要更名檔案的對話框。
   ...
   資產被視為大型資產的大小可以設定。 例如，您可以設定系統，將超過1000 MB（而非500 MB）的資產視為大型資產。 在這種情況下，當上傳大小大於1000 MB的資產時，進度列中的&#x200B;**[!UICONTROL Pause]**&#x200B;按鈕會出現。

   如果上傳的檔案大於1000 MB且檔案小於1000 MB，則不會顯示&#x200B;**[!UICONTROL 暫停]**&#x200B;按鈕。 但是，如果取消小於1000 MB的檔案上載，則會顯示&#x200B;**[!UICONTROL 暫停]**&#x200B;按鈕。

   要修改大小限制，請配置CRX儲存庫中`fileupload`節點的`chunkUploadMinFileSize`屬性。

   按一下&#x200B;**[!UICONTROL 暫停]**&#x200B;表徵圖時，它切換為&#x200B;**[!UICONTROL 播放]**&#x200B;表徵圖。 若要繼續上傳，請按一下&#x200B;**[!UICONTROL 播放]**&#x200B;圖示。

   ![chlimage_1-6](assets/chlimage_1-6.png)

   要取消正在進行的上載，請按一下進度欄旁的`X`按鈕。 當您取消上傳作業時，AEM Assets會刪除部分上傳的資產。
   ...
   >[!NOTE]
   >
   >**[!UICONTROL 僅當**[!UICONTROL &#x200B;重複檢測&#x200B;]**功能啟用時，才會顯示「檢測到的重複數」對話框。]**&#x200B;要啟用「重複檢測」功能，請參閱「啟用重複檢測」。](duplicate-detection.md)]**[**[!UICONTROL 
   ...
   * 資產資料夾名稱不可包含`* / : [ \ \ ] | # % { } ? \" . ^ ; + & \t`
   ...
   此外，「資產」介面會顯示您上傳的最新資產或您在所有檢視中首先建立的資料夾（**[!UICONTROL 卡片檢視]**、**[!UICONTROL 清單檢視]**&#x200B;和&#x200B;**[!UICONTROL 欄檢視]**）。

   通常，在同時上傳大型資產或多個資產時，視覺指標可讓您評估進度。 **[!UICONTROL 上傳進度]**&#x200B;對話方塊顯示成功上傳檔案的計數以及無法上傳的檔案。
...
1. 在預覽模式中，[支援的影像類型](assets-formats.md#supported-raster-image-formats)（使用互動編輯）可使用縮放選項。

   若要放大顯示資產，請點選&#x200B;**[!UICONTROL +]**（或點選資產上的放大鏡）。 若要縮小，請點選&#x200B;**[!UICONTROL -]**。 當您放大時，可以透過平移來仔細檢視影像的任何區域。 **[!UICONTROL 重設縮放]**&#x200B;箭頭會將您帶回原始檢視。

   ![上傳圖示](assets/uploadicon.png)

   點選&#x200B;**[!UICONTROL Reset]**&#x200B;按鈕，將檢視重設為原始大小。
...
1. 選取資產，然後從工具列點選「**[!UICONTROL 屬性]**」以檢視資產屬性。 或者，選擇資產卡上的&#x200B;**[!UICONTROL 屬性]**&#x200B;快速動作。

   ![properties_quickaction](assets/properties_quickaction.png)

1. 在&#x200B;**[!UICONTROL 屬性]**&#x200B;頁中，編輯各頁籤下的元資料屬性。 例如，在&#x200B;**[!UICONTROL Basic]**&#x200B;標籤下，編輯標題、說明等。

   **[!UICONTROL 屬性]**&#x200B;頁面的佈局和可用的元資料屬性取決於底層元資料架構。 要瞭解如何修改&#x200B;**[!UICONTROL 屬性]**&#x200B;頁的佈局，請參閱[元資料結構](metadata-schemas.md)。

1. 若要排程啟動資產的特定日期/時間，請使用「準時」欄位旁的日 **[!UICONTROL 期選擇器]** 。

   ![為資產設定「開啟時間」，讓資產在開啟與關閉時間之間有固定期間可用](assets/chlimage_1-12.png)

1. 若要在特定持續時間後停用資產，請從&#x200B;**[!UICONTROL 關閉時間]**&#x200B;欄位旁的日期選擇器選擇停用日期和時間。

   停用日期應晚於資產的啟用日期。 在[!UICONTROL 關閉時間]之後，資產及其轉譯無法透過「資產」網頁介面或HTTP API使用。
...
1. 若要檢視資產的使用情況統計資料，請點選&#x200B;**[!UICONTROL Insights]**&#x200B;標籤。
   ...
   * 最近使用資產的創意解決方案。
   ...
   如需詳細資訊，請參閱[資產分析](touch-ui-asset-insights.md)。
...
1. 從「資產」UI中，選取一或多個資產，然後點選工具列中的&#x200B;**[!UICONTROL Copy]**&#x200B;圖示。 或者，從資產卡中選擇&#x200B;**[!UICONTROL Copy]**&#x200B;快速動作。
...
1. 點選「**[!UICONTROL 全域導覽]**」圖示，然後從清單中選取「轉譯&#x200B;**[!UICONTROL a3/>」。]**
...
1. 選取要檢視或刪除轉譯的轉譯。
   ...
   **刪除轉譯**
   ...
   從&#x200B;**[!UICONTROL 轉譯]**&#x200B;面板中選擇轉譯，然後從[工具列](/help/sites-authoring/basic-handling.md)點選「刪除轉譯&#x200B;**[!UICONTROL 」圖示。]**&#x200B;資產處理完成後，無法大量刪除轉譯。 對於個別資產，您可以從使用者介面手動移除轉譯。 對於多個資產，您可以自訂Experience Manager以刪除特定轉譯或刪除資產，然後重新上傳已刪除的資產。
   ...
   **上傳新轉譯**
   ...
   若要設定視訊資產的轉譯維度，請導覽至位於`/libs/dam/gui/content/assets/assetpage/jcr:content/body/content/content/items/assetdetail/items/col1/items/assetview/videopicker`位置之CRX存放庫中的&#x200B;**[!UICONTROL videopicker]**&#x200B;節點，覆蓋該節點，然後編輯適當的屬性。

   >[!NOTE]
   >
   >只有採用HTML5相容視訊格式的瀏覽器才支援視訊註解。 此外，視瀏覽器而定，支援不同的視訊格式。

如需子資產的詳細資訊，請參閱[管理子資產](managing-linked-subassets.md)。
...
1. 在確認對話方塊中，點選：
   ...
   * **[!UICONTROL 取消]** 以停止操作
   * **[!UICONTROL 刪]** 除以根據以下條件確認操作：

      * 如果資產沒有參考，則會刪除資產。
      * 如果資產有參考，則會出現錯誤訊息通知您&#x200B;**[!UICONTROL 一或多個資產已參考]**。 您可以選取&#x200B;**[!UICONTROL 強制刪除]**&#x200B;或&#x200B;**[!UICONTROL 取消]**。

   >[!NOTE]
   >
   >若要解析或移除其他頁面的傳入參照，請先更新相關參照，再刪除資產。
   >
   >此外，也停用使用覆蓋的「強制刪除」按鈕，以禁止使用者刪除參照的資產並留下中斷的連結。]****[!UICONTROL 
...
基本搜索在[搜索和篩選器](/help/sites-authoring/search.md#search-and-filter)部分有詳細說明。 使用&#x200B;**[!UICONTROL Search]**&#x200B;面板來搜尋資產、標籤和中繼資料。 您可以使用通配符星號搜索字串的部分。 此外，您也可以使用[搜尋面](search-facets.md)來自訂&#x200B;**[!UICONTROL 搜尋]**&#x200B;面板。
...
您可以使用&#x200B;**[!UICONTROL 選擇]**&#x200B;圖示，檢視、導覽及選取任何可用檢視（卡片、欄、清單）的資產。 **[!UICONTROL 選]** 取項會在卡片檢視中顯示為快速動作。

![select_quick_action](assets/select_quick_action.png)

在清單檢視中，當您將滑鼠圖示暫留在縮圖上方，並置於清單中資產／資料夾名稱之前時，會出現&#x200B;**[!UICONTROL Select]**。

![select_quick_in_listview](assets/select_quick_in_listview.png)

與清單檢視類似，當您將滑鼠圖示暫留在縮圖上方，而欄檢視中的資產或資料夾名稱之前時，會顯示&#x200B;**[!UICONTROL Select]**。

![select_quick_in_columnview](assets/select_quick_in_columnview.png)

有關詳細資訊，請參閱[查看和選擇資源](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources)。
...
對於某些元件，**[!UICONTROL 全屏]**&#x200B;模式有其他可用選項。

要編輯TXT檔案，請在Configuration Manager中設定&#x200B;**[!UICONTROL Day CQ Link Externalizer]**。
...
1. 執行下列任一項作業，以在編輯模式中開啟資產：
   ...
   * 點選卡片檢視中資產上顯示的「編輯」**[!UICONTROL 選項。]**
   * 在資產頁面中，點選工具列中的&#x200B;**[!UICONTROL 編輯]**&#x200B;圖示。

   ![edit_icon](assets/edit_icon.png)

1. 若要裁切影像，請點選&#x200B;**[!UICONTROL Crop]**。
...
1. 使用右上角的&#x200B;**[!UICONTROL 完成]**&#x200B;選項裁切影像。 點選&#x200B;**[!UICONTROL 完成]**&#x200B;也會觸發轉譯的重新產生。

   ![chlimage_1-24](assets/chlimage_1-24.png)

1. 使用右上角的&#x200B;**[!UICONTROL 還原]**&#x200B;和&#x200B;**[!UICONTROL 重做]**&#x200B;圖示，分別回復為未裁切的影像或保留裁切的影像。
...
1. 在顯示的清單中，使用&#x200B;**[!UICONTROL 全部顯示]**&#x200B;清單，根據注釋、版本、工作流程和活動來篩選結果。
...
對於內容片段，[註解是在editor](content-fragments-variations.md#annotating-a-content-fragment)中建立的；此功能需要[AEM 6.4 Service Pack 2(6.4.2.0)](/help/release-notes/sp-release-notes.md)或更新版本。

您可以在儲存多個註解之前，先加入這些註解。

您可以新增附註至視訊資產。 在為視訊加上註解時，播放器會暫停，讓您在影格上加上註解。 如需詳細資訊，請參閱[管理視訊資產](managing-video-assets.md)。

您也可以新增註解至系列。 不過，如果系列包含子系列，您只能將註解或註解新增至父系列。 **[!UICONTROL Annotate]**&#x200B;選項不適用於子系列。

**要添加註釋**:

1. 導覽至您要新增附註的資產位置。
1. 點選下列其中一項的&#x200B;**[!UICONTROL Annotate]**&#x200B;圖示：
...
1. 添加註釋後，點選&#x200B;**[!UICONTROL Add]**&#x200B;保存注釋。 註解通知會傳送給Aaron。
...
1. 在&#x200B;**[!UICONTROL Annotation Color]**&#x200B;方塊中指定所要的顏色，然後點選&#x200B;**[!UICONTROL Accept]**。
...
1. 點選「**[!UICONTROL 全域導覽]**」圖示，然後從清單點選「時間軸&#x200B;]**」。**[!UICONTROL 
...
1. 在&#x200B;**[!UICONTROL 時間軸]**&#x200B;面板中點選注釋，以檢視影像上的對應註解。

   ![chlimage_1-37](assets/chlimage_1-37.png)

1. 點選&#x200B;**[!UICONTROL Delete]**&#x200B;以移除特定注釋。
...
1. 執行下列任一項作業：
   ...
   * 要打印所有注釋和審閱狀態，請轉至步驟4。
   * 要打印特定注釋和查看狀態，請開啟[時間軸](managing-assets-touch-ui.md#timeline)，然後繼續步驟3。

1. 要打印特定注釋，請從&#x200B;**[!UICONTROL 時間軸]**&#x200B;中選擇注釋。

   ![chlimage_1-38](assets/chlimage_1-38.png)

   要僅打印審閱狀態，請從&#x200B;**[!UICONTROL 時間軸]**&#x200B;中選擇該狀態。

   ![chlimage_1-39](assets/chlimage_1-39.png)

1. 在工具列上，點選&#x200B;**[!UICONTROL Print]**&#x200B;圖示。

   ![chlimage_1-40](assets/chlimage_1-40.png)

1. 從&#x200B;**[!UICONTROL 列印]**&#x200B;對話方塊中，選擇您要在PDF上顯示註解或審閱狀態的位置。 例如，如果您希望註解或狀態在包含已打印影像的頁面的右上方打印，請使用&#x200B;**[!UICONTROL 左上]**（預設）設定。

   ![chlimage_1-41](assets/chlimage_1-41.png)

   您可以根據要注釋或狀態顯示在打印的PDF中的位置選擇其他設定。 如果您希望註解或狀態顯示在與打印資產不同的頁面中，請選擇&#x200B;**[!UICONTROL 下一頁]**。

1. 點選&#x200B;**[!UICONTROL Print]**。 根據您在步驟2中選擇的選項，產生的PDF會在指定位置顯示註解或狀態。 例如，如果您選擇使用左上角設定打印注釋和審閱狀態 **** ，則生成的輸出類似於此處所示的PDF檔案。
...
1. 使用右上角的選項下載或列印PDF。
   ...
   要修改渲染的PDF檔案的外觀，例如注釋和狀態的字型顏色、大小和樣式、背景顏色，請從&#x200B;**[!UICONTROL 配置管理器]**&#x200B;開啟&#x200B;**[!UICONTROL 注釋PDF配置]**，並修改所需的選項。 例如，要更改批准狀態的顯示顏色，請修改相應欄位中的顏色代碼。 有關更改批注的字型顏色的資訊，請參閱[注釋](managing-assets-touch-ui.md#annotating)。
...
1. 按如下方式，使用正確的字型系列集配置&#x200B;**[!UICONTROL 注釋PDF]**:
...
1. 按一下底部的&#x200B;**[!UICONTROL 動作]**，以檢視可對資產執行的可用動作。

1. 按一下「另存新檔」，以建立資產的版本。****

   ![chlimage_1-46](assets/chlimage_1-46.png)

1. 新增標籤和註解，然後按一下「建立&#x200B;**[!UICONTROL 」以建立版本。]**&#x200B;或者，點選「**[!UICONTROL 取消」退出操作。]**

   ![chlimage_1-47](assets/chlimage_1-47.png)

1. 若要檢視新版本，請從資產詳細資料頁面或[!DNL Assets]介面開啟時間軸中的「顯示所有&#x200B;**[!UICONTROL 」清單，然後選擇「版本**[!UICONTROL 」]**。]**
...
* 具有&#x200B;**靜態參考清單**&#x200B;的資產、檔案夾和其他系列的系列。

* 使用&#x200B;**搜尋准則**&#x200B;並根據准則動態填入資產的系列。 這稱為&#x200B;**Smart Collection**。

如需系列管理的詳細資訊，請參閱[管理系列](managing-collections-touch-ui.md)。
