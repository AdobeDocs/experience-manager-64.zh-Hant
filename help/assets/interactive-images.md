...
seo-description: 瞭解如何在動態媒體中處理互動式影像
...
1. **在AEM中將互動式影像新增至您的網站或網站**
   ...
   * 如果您使用AEM Sites或AEM eCommerce，或兩者皆使用，您可以將Interactive Media元件拖曳至頁面，直接將互動影像新增至AEM的網頁。 請參閱[新增動態媒體資產至頁面](adding-dynamic-media-assets-to-pages.md)。
...
* 若要在Google Chrome中查看所有傳出的HTTP要求，請按F12以開啟&#x200B;**[!UICONTROL 開發人員工具]**&#x200B;面板，然後按一下&#x200B;**[!UICONTROL 網路]**&#x200B;標籤。

   在Mac上，按&#x200B;**[!UICONTROL Command+Option+I]**&#x200B;以開啟&#x200B;**[!UICONTROL 開發人員工具]**&#x200B;面板，然後按一下「網路」標籤。

* 在Firefox中，您可以按F12啟動Firebug外掛程式並使用其網路標籤，或使用內建的&#x200B;**[!UICONTROL Inspector]**&#x200B;工具及其&#x200B;**[!UICONTROL Network]**&#x200B;標籤。

   在Mac上，按&#x200B;**[!UICONTROL Command+Option+I]**&#x200B;以開啟「開發人員工具」面板，然後按一下「偵測器」標籤。********
...
示範網頁包含數個產品縮圖，每個產品縮圖都有標有&#x200B;**[!UICONTROL 「查看更多」的「快速檢視」按鈕。]**&#x200B;在您的網頁瀏覽器除錯工具仍處於啟用狀態時，按一下每個按鈕並記下錄制的Quickview URL。 在您啟動頁面上所有4種可用的Quickview產品後，您會有下列Quickview要求清單給後端：
...
您可以選擇使用AEM Assets隨附的預設、立即可用的互動式影像檢視器預設集，稱為&#x200B;**[!UICONTROL Shopbable_Banner]**。 或者，您也可以建立您自己的自訂檢視器預設集，以便用於互動式影像。

當您建立自訂的互動式影像檢視器預設集時，可以決定影像橫幅上熱點的外觀。 在建立檢視器預設集時，您可以選擇使用預先定義影像收藏館中的熱點圖形。

儲存檢視器預設集後，它會自動在「AEM資產」的「檢視器預設集」清單頁面上啟動（開啟）。 ****&#x200B;此功能表示它可在互動式媒體元件中顯示，且在您檢視資產時也可顯示。 不過，若要使用此檢視器預設集傳送&#x200B;*互動式橫幅，您也必須* publish *您的檢視器預設集（自訂或現成檢視器預設集也是如此）。*

**若要建立互動式影像檢視器預設集**:

1. 在左側導軌中，點選「**[!UICONTROL 工具>資產>檢視器預設集]**」。
1. 在頁面的右上角附近，點選&#x200B;**[!UICONTROL Create]**。
1. 在&#x200B;**[!UICONTROL 新檢視器預設集]**&#x200B;對話方塊中，輸入名稱以說明互動式橫幅檢視器預設集。

   此標題將在您儲存後出現在&#x200B;**[!UICONTROL 檢視器預設集]**&#x200B;清單頁面中。
1. 在&#x200B;**[!UICONTROL 多媒體類型]**&#x200B;下拉式功能表中，選擇&#x200B;**[!UICONTROL 互動式影像]**。
1. 點選&#x200B;**Create**。
1. 在&#x200B;**[!UICONTROL 編輯檢視器預設集]**&#x200B;頁面上，點選&#x200B;**[!UICONTROL 外觀]**&#x200B;標籤。
1. 執行下列任一項作業：

   * 若要上傳您要在影像上使用的自己熱點影像，請點選&#x200B;**[!UICONTROL 資產選擇器]**&#x200B;圖示。 在&#x200B;**[!UICONTROL 選擇內容]**&#x200B;頁面中，瀏覽至您要使用的熱點影像，選擇它，然後點選右上角的&#x200B;**[!UICONTROL 勾選標籤]**&#x200B;圖示。
   * 要選擇預定義的熱點影像，請按一下「熱點圖庫」表徵圖。 ****&#x200B;在熱點圖庫調色板上，點選要使用的熱點影像。

1. 在頁面的右上角附近，點選&#x200B;**[!UICONTROL Save]**。

   請確定您已發佈新的檢視器預設集。

   請參閱[您已新增的Publishing Viewer預設集](managing-viewer-presets.md#publishing-viewer-presets)。
...
**[!UICONTROL 在您目]** 前的 **** 建立／編輯工作階段中，會支援位於頁面右上角的Undoand Redooptions。

當您建立完互動影像後，可以使用&#x200B;**[!UICONTROL Preview]**&#x200B;來呈現您的互動影像對客戶的呈現方式。
...
1. 執行下列任一項作業：
   ...
   * 點選影像以在&#x200B;**[!UICONTROL 詳細資料檢視]**&#x200B;頁面中開啟影像。 在工具列上，點選&#x200B;**[!UICONTROL 編輯]**。

1. 在頁面的左上角附近，點選「新增熱點&#x200B;**[!UICONTROL 」（手指點選圖示）以開啟「熱點管理]**」頁面。]****[!UICONTROL 
1. 在頁面的左上角附近，點選&#x200B;**[!UICONTROL 熱點]**。
1. a.在&#x200B;**熱點管理**&#x200B;頁面的左上角附近，點選&#x200B;**[!UICONTROL 熱點]**。
b.在影像上，點選您要熱點出現的位置。 如有必要，請拖動熱點以調整其位置。c.通過重複步驟a和b，根據需要添加其他熱點。
d.（可選）要刪除熱點，請在影像上選擇該熱點，然後在**[!UICONTROL 熱點]**&#x200B;標題下按一下&#x200B;**[!UICONTROL 刪除]**（垃圾桶表徵圖）。

1. 在&#x200B;**[!UICONTROL 名稱]**&#x200B;文本欄位中，鍵入熱點的名稱。 此名稱也會出現在&#x200B;**[!UICONTROL 選定熱點]**&#x200B;下拉式清單中。
1. 執行下列任一項作業：

   * 點選&#x200B;**[!UICONTROL Quickview]**。

      * 如果您是AEM Sites或電子商務客戶，請點選「產品選擇器」圖示（放大鏡）以開啟「選擇產品」頁面。 ********&#x200B;點選您要使用的產品，然後點選頁面右上角的&#x200B;**[!UICONTROL Select]**&#x200B;以返回至&#x200B;**[!UICONTROL 熱點管理]**&#x200B;頁面。
   ...
   * 點選&#x200B;**超連結**。
      ...
      * 如果您是AEM Sites客戶，請點選「**[!UICONTROL 網站選擇器]**」圖示（資料夾）以導覽至URL。 請注意，如果您的互動式內容具有相對URL的連結，尤其是AEM Sites頁面的連結，就無法使用以URL為基礎的連結方法。
   ...
   * 點選&#x200B;**體驗片段**。
      ...
      * 如果您是AEM Sites客戶，請點選「**[!UICONTROL Search]**」圖示（放大鏡）以開啟「體驗片段&#x200B;]**」頁面。**[!UICONTROL &#x200B;點選您要使用的體驗片段，然後點選頁面右上角的&#x200B;**[!UICONTROL Select]**&#x200B;以返回熱點管理頁面。
...
1. 點選「**[!UICONTROL 儲存]**」以儲存您的作品並返回「瀏覽&#x200B;**[!UICONTROL a3/>」頁面。]**
...
請參閱[將URL連結至您的Web應用程式](linking-urls-to-yourwebapplication.md)。 請注意，如果您的互動式內容具有相對URL的連結，尤其是AEM Sites頁面的連結，就無法使用以URL為基礎的連結方法。\
請參閱[新增動態媒體資產至頁面。](adding-dynamic-media-assets-to-pages.md)

**若要預覽互動式影像**:

1. 在「資產」檢視中，導覽至您已建立的現有互動影像，然後點選以在「預覽」中開啟它。
1. 在「預覽」頁面的左上角附近，在&#x200B;**[!UICONTROL Content]**&#x200B;下拉式清單中，點選&#x200B;**[!UICONTROL Viewers]**。
1. 在&#x200B;**[!UICONTROL 檢視器]**&#x200B;清單中，點選&#x200B;**[!UICONTROL Shopbable_Banner]**&#x200B;或您所建立的互動式影像檢視器預設集的名稱。
1. 點選影像上的熱點，以測試其相關動作。
...
如果您是AEM Sites客戶，可將互動式媒體元件拖曳至您的頁面，以新增互動式影像。 請參閱[新增動態媒體資產至頁面。](adding-dynamic-media-assets-to-pages.md)
