...
1. **將熱點添加到影像橫幅** -將一個或多個熱點添加到影像橫幅中，並將每個熱點與超連結、快速視圖或體驗片段等操作關聯。 添加熱點後，將通過發佈互動式影像完成此任務。
   ...
   * 如需如 [何發佈互動式影像資產](publishing-dynamicmedia-assets.md) ，請參閱發佈資產。
...
* 使用者在網站上啟動使用者介面元素。例如，按一下「快 **[!UICONTROL 速視圖]** 」按鈕。
...
* 若要在Google Chrome中查看所有傳出的HTTP要求，請按F12以開啟「 **[!UICONTROL Developer Tools]** 」面板，然後按一下「 **[!UICONTROL Network]** 」標籤。

   在Mac上，按 **[!UICONTROL Command+Option+I]** ，開啟「 **[!UICONTROL Developer Tools]** 」面板，然後按一下「Network」標籤。
...
* In Firefox, you can either activate the Firebug plug-in by pressing F12 and use its Net tab, or you can use the built-in **[!UICONTROL Inspector]** tool and its **[!UICONTROL Network]** tab.
   ...
   在Mac上，按 **[!UICONTROL Command+Option+I]** ，開啟「 **[!UICONTROL Developer Tools]** 」面板，然後按一下「 **[!UICONTROL Inspector]** 」標籤。
...
儲存檢視器預設集後，就會在AEM Assets的「檢視器預設集」清單頁面 **[!UICONTROL 上自動啟動]** （開啟）它。 此功能表示它可在互動式媒體元件中顯示，且在您檢視資產時也可顯示。 不過，若要 *傳送*** 含此檢視器預設集的互動式橫幅，您也必須發佈您的檢視器預設集（自訂或現成可用的檢視器預設集也是如此）。

**若要建立互動式影像檢視器預設集**:

1. 在左側導軌中，點選「工 **[!UICONTROL 具>資產>檢視器預設集」]**。
1. Near the upper-right corner of the page, tap **[!UICONTROL Create]**.
1. 在「新建 **[!UICONTROL 檢視器預設集]** 」對話方塊中，輸入名稱以說明互動式橫幅檢視器預設集。

   這是在您儲存後，將會顯示在「檢 **[!UICONTROL 視器預設集]** 」清單頁面中的標題。
...
1. 執行下列任一項作業：
   ...
   * 若要上傳您要在影像上使用的自己熱點影像，請點選「資 **[!UICONTROL 產選擇器]** 」圖示。 在「選 **[!UICONTROL 取內容]** 」頁面中，導覽至您要使用的熱點影像，選取它，然後點選右上角的「勾選標籤 **** 」圖示。
   * 若要選取預先定義的熱點影像，請點選「熱 **[!UICONTROL 點圖庫」圖示]** 。 在熱點圖庫調色板上，點選要使用的熱點影像。

1. Near the upper-right corner of the page, tap **[!UICONTROL Save]**.

   請確定您已發佈新的檢視器預設集。

   請參 [閱已新增的Publishing Viewer預設集](managing-viewer-presets.md#publishing-viewer-presets)。
...
您可以使用「熱點管理」頁上的編輯器將熱點添加 **[!UICONTROL 到影像]** 橫幅。
...
當您完成互動影像的建立時，可以使用「預 **[!UICONTROL 覽]** 」來呈現您的互動影像對客戶的呈現方式。
...
1. 執行下列任一項作業：
   ...
   * 點選「 **超連結**」。
      ...
      * 如果您是AEM Sites客戶，請點選「網站選 **[!UICONTROL 擇器]** 」圖示（資料夾）以導覽至URL。 請注意，如果您的互動式內容具有相對URL的連結，尤其是AEM Sites頁面的連結，就無法使用以URL為基礎的連結方法。
   ...
   * Tap **Experience Fragment**.
      ...
      * 如果您是AEM Sites客戶，請點選「 **[!UICONTROL Search]** 」圖示（放大鏡）以開啟「 **[!UICONTROL Experience Fragment]** 」頁面。 點選您要使用的體驗片段，然後點選頁 **[!UICONTROL 面右上角的]** 「選取」，返回熱點管理頁面。
...
1. 點選 **[!UICONTROL 「儲存]** 」以儲存您的工作並返回 **[!UICONTROL 「瀏覽]** 」頁。
...
1. 在「預覽」頁面的左上角附近，在「內容」下拉式清單中，點選「檢 **[!UICONTROL 視器」]******。
1. 在「檢 **[!UICONTROL 視器]** 」清單中，點選 **[!UICONTROL Shopbable_Banner]** ，或您所建立的互動式影像檢視器預設集的名稱。
1. 點選影像上的熱點，以測試其相關動作。
...
如果您是AEM Sites客戶，可將互動式媒體元件拖曳至您的頁面，以新增互動式影像。 See [Adding Dynamic Media Assets to Pages.](adding-dynamic-media-assets-to-pages.md)
