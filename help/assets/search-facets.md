...
1. From the Search Forms page, select **[!UICONTROL Assets Admin Search Rail]**, then tap  **Edit** ![aemassets_edit](assets/aemassets_edit.png).
   ...
   > 
   >1. 導覽至 *CRX-DE中的/conf/global/settings/dam/search/facets/assets/jcr:content* /items。
   >1. 刪除 **type節點** 。
...
## 添加選項謂語 {#adding-an-options-predicate}
...
1. 執行下列任一項作業：
   ...
   * 點選 ![「選項](assets/do-not-localize/aem_assets_add_icon.png) 」欄位旁的「新增」圖示，以指定您要在「篩選」面板中提供之選項的顯示文字和值。 若要新增其他選項，請點選／按一 ![下「新增」圖示](assets/do-not-localize/aem_assets_add_icon.png) ，然後重複此步驟。
...
1. 在工 **[!UICONTROL 具列中]** ，點選 ![「刪除刪除大綱](assets/deleteoutline.png) 」。
