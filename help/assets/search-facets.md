...
1. 點選/按一下 [!DNL Experience Manager] 標誌，然後轉到 **[!UICONTROL 工具]** > **[!UICONTROL 一般]** > **[!UICONTROL 搜尋Forms]**.
1. 從「搜尋Forms」頁面中，選取 **[!UICONTROL Assets管理搜尋邊欄]**，然後點選  **編輯** ![aemassets_edit](assets/aemassets_edit.png).
   ...
   >[!NOTE]
   >
   >使用預先設定的資料夾搜尋功能 **Assets管理搜尋邊欄** 從早期 [!DNL Experience Manager] 版本，請執行下列步驟：
   > 
...
1. 點選/按一下 **[!UICONTROL 預覽]** ![預覽](assets/preview.png) 若要產生「篩選器」面板的預覽，如新增述詞後所顯示。
1. 在「預覽」模式中檢閱述詞的配置。
...
1. 若要關閉預覽，請點選/按一下 **[!UICONTROL 關閉]** ![close](assets/close.png) 在預覽的右上角。
...
1. 點選 [!DNL Experience Manager] 標誌，然後轉到 **[!UICONTROL 工具>一般>搜尋Forms]**.
...
1. 執行下列任一項作業：
   ...
   * 點選 ![新增圖示](assets/do-not-localize/aem_assets_add_icon.png) 「選項」欄位旁邊，指定要在「篩選器」面板中提供的選項的顯示文本和值。 若要新增其他選項，請點選/按一下 ![新增圖示](assets/do-not-localize/aem_assets_add_icon.png) 並重複步驟。
...
「多值屬性」述詞可讓您搜尋多個值的資產。 假設您的 [!DNL Experience Manager] 每個影像的資產和中繼資料包含與產品相關聯的SKU編號。 您可以使用此述詞來根據多個SKU編號來搜尋產品影像。
...
1. 點選 **[!UICONTROL 刪除]** ![deleteoutline](assets/deleteoutline.png) 的下一頁。
