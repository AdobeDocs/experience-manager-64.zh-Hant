...
>[!NOTE]
>
>ImageMagick policy.xml和configure.xml檔案可在/usr/lib64/ImageMagick-&amp;ast;/config/（而非/etc/ImageMagick/）下找到。 有關配置檔案 [位置的詳細資訊](https://www.imagemagick.org/script/resources.php) ，請參閱ImageMagick文檔。
