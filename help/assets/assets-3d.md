...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>相機</td> 
   <td><p>選擇<strong>3D級</strong>。</p> <p>取消選取3D模型。</p> </td> 
  </tr> 
  <tr> 
   <td>光源</td> 
   <td><p>選擇<strong>3D級</strong>。</p> <p>取消選擇<strong>3D模型</strong>。</p> </td> 
  </tr> 
  <tr> 
   <td>設備——自動</td> 
  ...
  <tr> 
   <td>FBX檔案格式——類型</td> 
   <td>同時支援<strong>二進位</strong>或<strong>ASCII </strong>。</td> 
  </tr> 
  <tr> 
   <td>FBX檔案格式——版本</td> 
...
### 支援紋理映射檔案{#support-for-texture-map-files}
...
## 主3D模型檔案{#material-shading-in-a-primary-d-model-file}中的材料著色
