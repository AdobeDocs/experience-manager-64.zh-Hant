...
>[!NOTE]
>
>如果您使用AEM 6.3或更舊版本，而且需要為資產自動標籤服務，請參閱「智慧 [標籤」](https://helpx.adobe.com/experience-manager/6-3/assets/using/touch-ui-smart-tags.html)。 智慧型標籤不會使用AI功能，而且比「增強的智慧型標籤」功能不精確。
...
1. 若要下載報表，請從清單中選取報表，然後點選／按一下工具列 **[!UICONTROL 中的]** 「下載」圖示。 報表會下載為Excel檔案。
...
1. 點選／按一下底部的箭頭，然後點選／按一下「開始工 **[!UICONTROL 作流程]**」。
