...
## 增強的智慧型標籤簡介{#overview-of-enhanced-smart-tags}
...
接著，檢閱影像，以識別最能代表您產品符合特定業務需求的影像集。 確保組織集中的資產符合[智慧型內容服務訓練方針](smart-tags-training-guidelines.md)。
...
您可以讓智慧型內容服務定期培訓資料夾中的資產和相關標籤。 開啟資產資料夾的屬性頁，在&#x200B;**[!UICONTROL Details]**&#x200B;頁籤下選擇&#x200B;**[!UICONTROL 啟用智慧標籤]**，並保存更改。
...
1. 指定工作流程的標題並新增註解。 然後點選／按一下&#x200B;**[!UICONTROL Run]**。 資產和標籤會提交以供培訓。
...
1. 若要下載報表，請從清單中選取報表，然後點選／按一下工具列中的&#x200B;**[!UICONTROL 下載]**&#x200B;圖示。 報表會下載為Excel檔案。
...
1. 指定工作流程的標題和選用的註解。 然後點選／按一下&#x200B;**[!UICONTROL Run]**。

   ![tagging_dialog](assets/tagging_dialog.png)

   導覽至資產資料夾並檢閱標籤，以確認Smart Content Service是否正確標籤您的資產。 如需詳細資訊，請參閱[管理智慧型標籤](managing-smart-tags.md)。

#### 從時間軸{#tagging-assets-from-the-timeline}標籤資產

1. 從「資產」使用者介面中，選取包含您要套用智慧標籤之資產或特定資產的檔案夾。
1. 點選／按一下GlobalNav圖示並開啟時間軸。
1. 點選／按一下底部的箭頭，然後點選／按一下「開始工作流程」**[!UICONTROL 。]**

   ![start_workflow](assets/start_workflow.png)

1. 選擇&#x200B;**[!UICONTROL DAM智慧型標籤資產]**&#x200B;工作流程，並指定工作流程的標題。
1. 點選／按一下&#x200B;**[!UICONTROL 開始]**。 工作流程會將您的標籤套用在資產上。 導覽至資產資料夾並檢閱標籤，以確認Smart Content Service是否正確標籤您的資產。 如需詳細資訊，請參閱[管理智慧型標籤](managing-smart-tags.md)。
