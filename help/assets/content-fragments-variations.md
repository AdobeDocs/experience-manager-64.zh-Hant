...
1. 選擇&#x200B;**[!UICONTROL Master]**&#x200B;或所需的變化。
1. 開啟全螢幕編輯器。
1. 選取一些文字。 **[!UICONTROL Annotate]**&#x200B;圖示變為可用。

   ![cfm-6420-24](assets/cfm-6420-24.png)

1. 對話方塊將會開啟。 您可以在這裡輸入注釋。

1. 關閉全螢幕編輯器和&#x200B;**[!UICONTROL 儲存]**&#x200B;片段。
...
* 通過選擇片段編輯器中的&#x200B;**[!UICONTROL Annotations]**&#x200B;頁籤，可以列出和刪除。

   ![cfm-6420-25](assets/cfm-6420-25.png)

* 可在[時間軸](https://helpx.adobe.com/experience-manager/6-3/assets/using/content-fragments-managing.html#timeline-for-content-fragments)中檢視和刪除所選片段。
...
1. 開啟您的片段，並確保側面板可見。
1. 從側面板的表徵圖欄中選擇&#x200B;**[!UICONTROL Valuations]**。
1. 選擇&#x200B;**[!UICONTROL 建立變化]**。
...
1. 開啟片段，然後從側面板中選擇&#x200B;**[!UICONTROL Valuations]**。
1. 選擇所需的變化。
1. 從&#x200B;**[!UICONTROL 操作]**&#x200B;下拉清單中選擇&#x200B;**[!UICONTROL 更名]**。
...
1. 開啟片段，然後從側面板中選擇&#x200B;**[!UICONTROL Valuations]**。
1. 選擇所需的變化。
1. 從&#x200B;**[!UICONTROL 操作]**&#x200B;下拉清單中選擇&#x200B;**[!UICONTROL 刪除]**。
