---
title: 非同步操作可提高效能
description: AEM Assets中的非同步作業概觀。
contentOwner: AG
...
為了降低對效能的不利影響，Adobe Experience Manager(AEM)Assets會非同步處理某些長期執行且資源密集的資產作業。 這些操作包括：
...
要詳細查看非同步操作的狀態，請定位至「非同步作業狀 **態」頁** 。

1. 點選/按一下 AEM 標誌，然後前往&#x200B;**[!UICONTROL 「資產」>「工作」]**。
...
1. 點選/按一下AEM標誌，然後前往「工 **[!UICONTROL 具 > 作業 > Web Console]**」。
