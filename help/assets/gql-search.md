---
title: GQL全文搜索
description: 探索GQL全文搜索功能，位於 [!DNL Experience Manager] 資產。 使用它根據特定中繼資料（例如標題、說明和作者名稱）來搜尋資產。
contentOwner: AG
...
探索GQL全文搜索功能，位於 [!DNL Experience Manager] 資產。 使用它根據特定中繼資料（例如標題、說明和作者名稱）來搜尋資產。
...
1. 在「資產」使用者介面的工具列中，按一下或點選 **[!UICONTROL 搜尋]** 圖示來顯示「Omnisearch」方塊。

   ![](assets/do-not-localize/chlimage_1.png)

1. 在Omnisearch框中，按Enter鍵。
1. 按一下或點選「全域導覽」圖示以顯示 **[!UICONTROL 篩選器]** 中。
...
1. Press **[!UICONTROL 輸入]**. 此 [!DNL Assets] 使用者介面只會顯示標題完全符合「Target」的資產。
...
| [!UICONTROL 到期日] | 過期:YYYY-MM-DDTHH:MM:SS.000+05:30..YYYY-MM-DDTHH:MM:SS.000+05:30 |
...
| [!UICONTROL 時間範圍] （過期日期、offtime） | 面向欄位：下界……上界限 |
| [!UICONTROL 路徑] | /content/dam/&lt;folder name=&quot;&quot;> |
...
1. 切換至 **[!UICONTROL 進階]** 標籤，按一下/點選 **[!UICONTROL 新增]** 在 **[!UICONTROL Elevate搜索關鍵字]**.

   ![elevate_for_search](assets/elevate_for_search.png)

1. 在 **[!UICONTROL Search Promote]** 框中，指定要加大對影像搜索的關鍵字，然後按一下/點選 **[!UICONTROL 新增]**. 如有必要，請以相同的方式指定多個關鍵字。
