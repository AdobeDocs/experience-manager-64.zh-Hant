...
>[!NOTE]
>
>如果您針對複雜資產(例如PDF和InDesign檔案)啟動翻譯工作流程，則不會提交其子資產或轉譯（如果有）以供翻譯。

## 建立並翻譯工作流{#create-and-translate-workflow}

您使用「建立和翻譯」工作流程，第一次針對特定語言產生語言副本。 工作流程提供下列選項：
...
1. 要啟動資產的翻譯，請按一下／點選&#x200B;**[!UICONTROL 翻譯作業]**&#x200B;表徵圖上的箭頭，然後從清單中選擇&#x200B;**[!UICONTROL 開始]**。
