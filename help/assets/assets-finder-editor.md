...
1. 在「網 **[!UICONTROL 站]** 」標籤中，導覽至您要建立資產共用頁面的位置，然後按一下「新 **[!UICONTROL 增」]**。

1. 選取「資 **[!UICONTROL 產共用]** 」頁面，然後按 **[!UICONTROL 一下「建立]**」。 會建立新頁面，資產共用頁面會列在「網站」標 **[!UICONTROL 簽中]** 。
...
1. 在數位資產管理員的「新增 **[!UICONTROL 」中]**，選 **[!UICONTROL 取「新增資產共用」]**。
1. 在「標 **[!UICONTROL 題]**」中，輸入資產共用頁面的名稱。 視需要輸入URL的名稱。
...
1. 在您要自訂的「資產共用」頁面中，按一下側 **[!UICONTROL 點中]** 的「動作」。
...
1. 在您要自訂的「資產共用」頁面中，按一下「搜 **[!UICONTROL 尋」]**。
...
1. 在您要自訂的「資產共用」頁面中，按一下「查詢產 **[!UICONTROL 生器]** 」中的「編輯」。 預設情況下，將開啟「 **[!UICONTROL 常規]** 」頁籤。

1. 選擇每頁結果數、資產編輯器的路徑（如果您有自訂的資產編輯器）和「動作」標題。

   ![screen_shot_2012-04-23at15055pm](assets/screen_shot_2012-04-23at15055pm.png)

1. 按一下「 **[!UICONTROL 路徑]** 」標籤。 輸入將運行搜索的路徑或多個路徑。 如果用戶使用「路徑」述詞，則覆寫這些路徑。

   ![screen_shot_2012-04-23at15150pm](assets/screen_shot_2012-04-23at15150pm.png)

1. 如果需要，輸入另一個節點類型。

1. 在「查 **[!UICONTROL 詢產生器URL]** 」欄位中，您可以覆寫或包住查詢產生器，並使用現有的查詢產生器元件輸入新的servlet URL。 在「動 **[!UICONTROL 態消息URL]** 」欄位中，您也可以覆寫動態消息URL。

   ![screen_shot_2012-04-23at15313pm](assets/screen_shot_2012-04-23at15313pm.png)

1. 在「文 **[!UICONTROL 字]** 」欄位中，輸入要顯示結果和結果頁碼的文字。 完成 **[!UICONTROL 更改後]** ，按一下「確定」。
...
如需詳細資訊，請參 [閱predicate javadocs](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/eval/package-summary.html)。
...
1. 在「網 **[!UICONTROL 站]** 」標籤中，導覽至您要建立資產編輯器頁面的位置，然後按一下「新 **[!UICONTROL 增」]**。

1. 選取「 **[!UICONTROL Geometrixx Asset Editor」（Geometrixx資產編輯器）]** ，然後按一 **[!UICONTROL 下「建立]**」。 新頁面隨即建立，頁面會列在「網站」 **[!UICONTROL 標籤]** 中。
...
若要自訂資產編輯器頁面，請使用sidekick中的元素。 從 **** Geometrixx Press Center存取的「資產編輯器」頁面是以此範本為基礎的自訂頁面版本：
...
1. 在「資產共用」頁面中，按一下「 **[!UICONTROL 查詢產生器]** 」旁的「編輯」。

   ![screen_shot_2012-04-23at20123pm](assets/screen_shot_2012-04-23at20123pm.png)

1. 如果尚未選 **[!UICONTROL 擇]** 「常規」頁籤，請按一下該頁籤。

1. 在「資 **[!UICONTROL 產編輯器的路徑」欄位中]** ，輸入您要讓「資產共用」頁面在中開啟資產的資產編輯器的路徑，然後按一下「確 **[!UICONTROL 定」]**。
...
1. 在您要自訂的「資產編輯器」頁面中，選取側 **[!UICONTROL 點中的「資產編輯器]** 」。 將顯示所有可用的資產編輯器元件。
...
中繼資料表單是包含開始和結束動作的表單。 在中間輸入「文 **[!UICONTROL 本]** 」欄位。 如需使 [用表單的詳細資訊](../sites-authoring/default-components.md) ，請參閱表單。

1. 按一下表單「開始」區 **[!UICONTROL 域中的]** 「編輯」，建立開始動作。 您可以視需要輸入「方塊」標題。 依預設，「方塊」標題為「中繼 **[!UICONTROL 資料」]**。 如果要生成用於驗證的java-script客戶端代碼，請選中「客戶端驗證」複選框。

   ![screen_shot_2012-04-23at22911pm](assets/screen_shot_2012-04-23at22911pm.png)

1. 通過按一下表單的「結 **[!UICONTROL 束]** 」區域中的「編輯」(Edit)建立「結束」(End)操作。 例如，您可能想要建立「提交」 **[!UICONTROL 按鈕]** ，讓使用者提交其中繼資料變更。 或者，您可以新增「重設 **[!UICONTROL 」按鈕]** ，將中繼資料重設為其原始狀態。

   ![screen_shot_2012-04-23at23138pm](assets/screen_shot_2012-04-23at23138pm.png)

1. 在「表單開 **[!UICONTROL 始]** 」和「表 **單結束」之間**，將中繼資料文字欄位拖曳至表單。 使用者將中繼資料填入這些文字欄位，以提交或完成其他動作。

1. 連按兩下欄位名稱，例如 **Title** ，以開啟中繼資料欄位並進行變更。 在「編 **[!UICONTROL 輯元件]** 」窗口的「常規」頁籤中，定義命名空間和欄位標籤以及類型，例如 `dc:title`。


   ![screen_shot_2012-04-23at23305pm](assets/screen_shot_2012-04-23at23305pm.png)

   如需 [](extending-assets.md) 修改中繼資料表單中可用名稱空間的詳細資訊，請參閱自訂和擴充AEM資產。

1. 按一下「約 **[!UICONTROL 束]** 」(Constraints)頁籤。 您可以在此處選擇欄位是否為必需欄位，並根據需要添加任何約束。

   ![screen_shot_2012-04-23at23435pm](assets/screen_shot_2012-04-23at23435pm.png)

1. 按一下「顯 **[!UICONTROL 示]** 」標籤。 在這裡，您可以為中繼資料欄位輸入新的寬度和行數。 選取「 **欄位為唯讀** 」核取方塊，讓使用者編輯中繼資料。
...
子資產元件是您可以檢視及選取子資產的位置。 您可以決定主要資產和子 [資產下](assets.md#what-are-digital-assets) ，顯示哪些名稱。
...
連按兩下「標籤」元件以開啟「標籤」對話方塊，您可在其中視需要從「標籤」中變更標題，以及選取已分配的名稱空間。 若要讓此欄位可編輯，請清除「 **隱藏編輯** 」按鈕核取方塊。 依預設，標籤是可編輯的。
...
Thumbnail元件是資產顯示所選縮圖的位置（對於許多格式，會自動擷取縮圖）。 此外，元件會顯示檔案名稱，以 [及您可修改的動作](assets-finder-editor.md#adding-asset-editor-actions)。

![screen_shot_2012-04-23at25452pm](assets/screen_shot_2012-04-23at25452pm.png)

連按兩下縮圖元件，以開啟縮圖對話方塊，您可在其中變更alt文字。 依預設，縮圖alt文字預設為「按 **[!UICONTROL 一下以下載資產]** 」。
...
1. 在您要自訂的「資產編輯器」頁面中，按一下側 **[!UICONTROL 點中的「資產編輯器]** 」。<br>
...
## 使用「資產編輯器」頁面編輯多個資產 {#multi-editing-assets-with-the-asset-editor-page}
...
1. 開啟Geometrixx **[!UICONTROL Press Center]** 頁面，網址為 `http://localhost:4502/content/geometrixx/en/company/press.html`。
1. 選取資產：
...
1. 按一 **[!UICONTROL 下「動作]****** 」欄位（頁面左側）中的「編輯中繼資料」。

1. 「Geometrixx **[!UICONTROL Press Center Asset Editor]** 」（Geometrixx按中心資產編輯器）頁面會在新標籤中開啟。 資產的中繼資料顯示如下：

   * 標籤（不適用於所有資產，但僅適用於少數資產）會以斜體顯示。
   * 套用至所有資產的標籤會以一般字型顯示。
   * 除標籤以外的中繼資料：只有在所有選取資產的欄位值相同時，才會顯示欄位值。

1. 按一 **[!UICONTROL 下「下載]** 」以下載包含資產原始轉譯的ZIP檔案。
1. 按一下「標籤」欄位旁 **[!UICONTROL 的鉛筆圖示]** ，以編輯標籤：
   ...
   * 按一下 `x` 圖示以移除所有資產的標籤。
   * 按一下 `+` 圖示，將標籤新增至所有資產。
   * 按一 `arrow` 下並選取標籤，以新增標籤至所有資產。
   按一下 **[!UICONTROL 確定]** ，將更改寫入表單。 「標籤」欄位旁 **的方塊** ，會自動勾選。
...
1. 按一 **[!UICONTROL 下「更新中繼資料]** 」以提交表單並儲存所有資產的變更。 僅會修改已勾選的中繼資料。
