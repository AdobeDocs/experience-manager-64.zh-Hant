---
title: 管理 [!DNL Adobe Experience Manager Assets]中的 [!DNL Adobe Stock] 資產。
...
整合需要[企業版Adobe Stock計畫](https://stockenterprise.adobe.com/)和[!DNL Experience Manager] 6.4，並至少部署Service Pack 2。 有關[!DNL Experience Manager] 6.4 Service Pack的詳細資訊，請參見以下[發行說明](/help/release-notes/sp-release-notes.md)。
...
1. 按一下「**[!UICONTROL 建立新項目]**」，然後按一下「**[!UICONTROL 添加API]**」。 從[!UICONTROL 可供您使用的API清單中選擇&#x200B;**[!UICONTROL Adobe Stock]**。 ]選擇[!UICONTROL OAUTH 2.0 Web]。 設定並複製顯示的各種值。
...
1. 在[!DNL Experience Manager]用戶介面中，導航至&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL Cloud Services]** > **[!UICONTROL Adobe Stock]**。
...
>[!NOTE]
>
>如果有多個[!DNL Adobe Stock]配置，請在「用戶首選項」面板(**[!UICONTROL AEM]** > **[!UICONTROL 用戶表徵圖]** > **[!UICONTROL 用戶首選項]** > **[!UICONTROL Stock配置]**)中選擇所需的配置。
...
* 若要搜尋[!DNL Adobe Stock]和[!DNL Experience Manager Assets]的資產，請按一下搜尋![search_icon](assets/search_icon.png)。
...
>* [Adobe Stock企業計畫幫助](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/adobe-stock-enterprise.ug.html)
