...
整合需要企 [業版Adobe Stock計畫](https://stockenterprise.adobe.com/) , [!DNL Experience Manager] 以及至少部署Service Pack 2的6.4。 如需 [!DNL Experience Manager] 6.4 Service Pack詳細資訊，請參閱這些 [發行說明](/help/release-notes/sp-release-notes.md)。
