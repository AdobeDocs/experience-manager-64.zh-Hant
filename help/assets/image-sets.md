...
「影像集」是由字詞&#x200B;**[!UICONTROL IMAGESET]**&#x200B;的橫幅所指定。 此外，如果已發佈影像集，則會顯示以 **[!UICONTROL World]** 圖示表示的發佈日期與上次修改日期(以 **** Pencil圖示表示)在橫幅上。
...
1. [建立影像集。](#creating-image-sets)
   ...
   若要在「資產」中建立影像集，請點選&#x200B;**[!UICONTROL 「建立>影像集」]**。 然後，新增影像並點選&#x200B;**[!UICONTROL Save]**。
...
1. 視需要新增[影像集檢視器預設集](managing-viewer-presets.md)。
   ...
   管理員可以建立或修改「影像&#x200B;**[!UICONTROL 設定查看器預設集]**」。 若要使用檢視器預設集來檢視您的影像集，請選取影像集，然後在左側導軌下拉式功能表中，選取&#x200B;**[!UICONTROL 檢視器]**。

   請參閱&#x200B;**[!UICONTROL 工具>資產>檢視器預設集]**&#x200B;以建立或編輯檢視器預設集。

1. （可選）[檢視使用批集預設集建立的影像集](image-sets.md#viewing-image-sets)。
1. [預覽影像集。](previewing-assets.md)

   選取「影像集」，您就可以預覽它。 點選縮圖圖示，以檢查所選檢視器中的影像集。 您可以從左側導軌下拉式選單的&#x200B;**[!UICONTROL 檢視器]**&#x200B;選單中選擇不同的檢視器。

1. [發佈影像集。](publishing-dynamicmedia-assets.md)

   發佈影像集會啟動URL和內嵌字串。 此外，您必須[發佈您所建立的任何自訂檢視器預設集](managing-viewer-presets.md)。 現成可用的檢視器預設集已發佈。
...
您可以像[上傳資產](managing-assets-touch-ui.md#uploading-assets)中的任何其他資產一樣，上傳影像集的影像。
...
1. 在&#x200B;**Assets**&#x200B;中，瀏覽至您要建立影像集的位置，點選&#x200B;**[!UICONTROL Create]**，然後選取&#x200B;**[!UICONTROL Image Set]**。 您也可以從包含資產的資料夾內建立資產集。
...
1. 執行下列任一項作業：
   ...
   * 在&#x200B;**[!UICONTROL 影像集編輯器]**&#x200B;頁面中間附近，點選&#x200B;**[!UICONTROL 以開啟資產選擇器]**。

   點選以選取您要包含在影像集中的資產。 選取的資產上面有核取標籤圖示。完成後，在頁面右上角附近點選&#x200B;**[!UICONTROL 選擇]**。
...
1. 當您將資產新增至集合時，資產會自動以字母數字順序新增。 您可以在新增資產後手動重新排序或排序資產。
   ...
   如有必要，將資產的&#x200B;**[!UICONTROL Reorder]**&#x200B;圖示拖曳至資產檔案名稱的右側，以在設定清單上或下重新排序影像。

   ![spin_set_assets](assets/spin_set_assets.png)

   如果您想要變更縮圖或色票，請點選影像旁的&#x200B;**[!UICONTROL 縮圖]**&#x200B;圖示，並導覽至您想要的縮圖或色票。 選擇完所有影像後，點選&#x200B;**[!UICONTROL Save]**。

1. （可選）執行下列任一項作業：

   * 若要刪除影像，請選取影像，然後點選「刪除資產」。****
   * 若要套用預設，請在頁面右上角附近點選&#x200B;**[!UICONTROL Preset]**，然後選取一個預設，一次套用至所有資產。

1. 點選&#x200B;**[!UICONTROL Save]**。 您新建立的「影像集」會顯示在您所建立的檔案夾中。
...
* 開啟個別資產的屬性時。 屬性指示所選資產是成員（在&#x200B;**[!UICONTROL 整合員]**&#x200B;下）的成員。 點選集的名稱可查看整個集。
