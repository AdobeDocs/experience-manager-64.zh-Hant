...
seo-description: 了解如何在Dynamic Media中使用影像集
...
影像集由具有&#x200B;**[!UICONTROL IMAGESET]**&#x200B;字的橫幅指定。 此外，如果已發佈影像集，則會顯示以 **[!UICONTROL World]** 圖示表示的發佈日期與上次修改日期(以 **** Pencil圖示表示)在橫幅上。
...
1. [建立影像集。](#creating-image-sets)
   ...
   若要在「資產」中建立影像集，請點選「**[!UICONTROL 建立>影像集]**」。 然後，新增影像並點選&#x200B;**[!UICONTROL 儲存]**。
...
1. 視需要新增[影像集檢視器預設集](managing-viewer-presets.md)。

   管理員可以建立或修改影像&#x200B;**[!UICONTROL 設定查看器預設集]**。 若要檢視您使用檢視器預設集所設定的影像集，請選取該影像集，然後在左側導軌下拉式選單中，選取「**[!UICONTROL 檢視器]**」。

   請參閱&#x200B;**[!UICONTROL 工具>資產>檢視器預設集]**&#x200B;以建立或編輯檢視器預設集。

1. （可選）[查看使用批集預設集建立的影像集](image-sets.md#viewing-image-sets)。
1. [預覽影像集。](previewing-assets.md)

   選取「影像集」，即可預覽。 點選縮圖圖示以檢查所選檢視器中的影像集。 您可以從&#x200B;**[!UICONTROL 檢視器]**&#x200B;選單中選擇不同的檢視器，該選單可從左側導軌下拉式選單中取得。

1. [發佈影像集。](publishing-dynamicmedia-assets.md)

   「發佈影像集」會啟用URL和「內嵌」字串。 此外，您必須[發佈您已建立的任何自訂檢視器預設集](managing-viewer-presets.md)。 已發佈現成可用的檢視器預設集。
...
**重要：** 批集由IPS(Image Production System)建立，作為資產擷取的一部分，僅可在Dynamic Media - Scene7模式中使用。
...
1. 在&#x200B;**Assets**&#x200B;中，導覽至您要建立影像集的位置，點選&#x200B;**[!UICONTROL Create]**，然後選取&#x200B;**[!UICONTROL Image Set]**。 您也可以從包含資產的資料夾內建立資產集。
...
1. 在「影像集編輯器」頁的&#x200B;**[!UICONTROL Title]**&#x200B;欄位中，輸入影像集的名稱。 名稱會出現在影像集的橫幅中。 （可選）輸入說明。
   ...
   >[!NOTE]
   >
   >建立影像集時，您可以變更影像集縮圖，或允許AEM根據影像集中的資產自動選取縮圖。若要選取縮圖，請點選&#x200B;**[!UICONTROL 變更縮圖]**&#x200B;並選取任何影像（您也可以導覽至其他資料夾以尋找影像）。 如果您已選取縮圖，然後決定要讓AEM從影像集產生縮圖，請選取「切換至 **[!UICONTROL 自動縮圖」]**。

1. 執行下列任一操作：

   * 在&#x200B;**[!UICONTROL 影像集編輯器]**&#x200B;頁面的左上角附近，點選&#x200B;**[!UICONTROL 新增資產]**。
   * 在&#x200B;**[!UICONTROL 影像集編輯器]**&#x200B;頁面中間附近，點選&#x200B;**[!UICONTROL 點選以開啟資產選取器]**。
...
1. 將資產新增至資產集時，資產會以英數字元順序自動新增。 新增資產後，您可以手動重新排序或排序資產。
   ...
   如有必要，請將資產的&#x200B;**[!UICONTROL Reorder]**&#x200B;圖示拖曳至資產檔案名稱的右側，以在設定清單上或下重新排序影像。

   ![spin_set_assets](assets/spin_set_assets.png)

   如果您想要變更縮圖或色票，請點選影像旁的&#x200B;**[!UICONTROL 縮圖]**&#x200B;圖示，並導覽至您想要的縮圖或色票。 選取完所有影像後，點選&#x200B;**[!UICONTROL 儲存]**。
...
**重要**  — 批集由IPS Image Production System [建立，] 是資產提取的一部分，並僅在Dynamic Media - Scene7模式中可用。)

但是，使用批集預設集建立的集，do *not*&#x200B;將出現在用戶介面中。 您可以透過三種不同方式來檢視這些集合。 （即使您在使用者介面中建立影像集，這些方法仍可供使用）。

* 開啟個別資產的屬性時。 屬性指明所選資產是的成員（在&#x200B;**[!UICONTROL 整合員]**&#x200B;下）。 點選集的名稱即可查看整個集。
...
* 在搜索中，可以選擇&#x200B;**[!UICONTROL Filters]**，然後展開&#x200B;**[!UICONTROL Dynamic Media]**&#x200B;並選擇&#x200B;**[!UICONTROL Sets]**。
...
1. 要編輯「影像集」中的影像，請執行以下操作之一：
   ...
   * 若要新增資產或更新現有資產，請點選「**[!UICONTROL 新增資產]**」。 導覽至資產，選取資產，然後點選頁面右上角的&#x200B;**[!UICONTROL 選取]**。
