...
>[!NOTE]
>
>此功能需要AEM 6.4並至少部署Service Pack 2。 如需AEM 6.4 Service Pack詳細資訊，請參閱這些版 [本注意事項](/help/release-notes/sp-release-notes.md)。
...
您可以從「資料夾元資料結構表單」頁或在建立資料夾時將資料夾元資料結構分配給資料夾。
