...
對於過期的資產，卡片上的標幟會指出其已過期。

![expired_flag_card](assets/expired_flag_card.png)

**清單檢視**

對於過期資產，「狀 **[!UICONTROL 態]** 」欄會顯示「 **[!UICONTROL 已到期]** 」橫幅。
...
1. 在「資產」主控台中，按一下工 **具列中的** 「搜尋」圖示，以顯示「全方位搜尋」方塊。
...
1. 若要根據資產狀態來搜尋資產，請按一下／點選「 **[!UICONTROL 搜尋]** 」圖示以顯示「全方位搜尋」列。
...
>[!NOTE]
>
>在舊版 *AEM中儲存授權的位置* /etc/dam/drm/licenses已不再使用。
>
>如果您建立或修改授權頁面，或從舊版AEM移植這些頁面，Adobe建議您將它們儲存在 */apps/settings/dam/drm/licenses**或/conf/&amp;ast;/settings/dam/drm/licenses下*。
