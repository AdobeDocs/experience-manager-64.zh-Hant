...
1. **在AEM中將互動式視訊新增至您的網站或網站**
   ...
   如果您使用AEM Sites或AEM eCommerce，或兩者皆使用，您可將互動式視訊直接拖曳至AEM的網頁上。 請參閱[新增動態媒體資產至頁面。](adding-dynamic-media-assets-to-pages.md)
...
如果您是AEM Sites客戶，可將Interactive Media元件拖曳至您的頁面，以新增互動式視訊。 請參閱[新增動態媒體資產至頁面。](adding-dynamic-media-assets-to-pages.md)
